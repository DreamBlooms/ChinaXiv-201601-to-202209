...
Micro-CT扫描结果示，顶椎终板凹侧的骨体积分数为 $0 . 7 6 { \scriptstyle \pm 0 . 0 9 }$ ,凸侧的骨体积分数为 $0 . 7 3 { \scriptstyle \pm 0 . 1 0 }$ ，对其行配对 $\mathbf { \Phi } _ { t }$ 检验后， $t { = } 2 . 6 2 7 , P { = } 0 . 0 1 7$ ,表明二者之间存在统计学差异。
