...
$$
\eta _ { \mathtt { S O l - f i e c } } = \frac { P } { \bar { Q } _ { \mathtt { S O l } } } \left( 1 - \frac { \bar { H } _ { \mathtt { M } } } { \bar { H } _ { \mathtt { S M } } } \right)
$$

其中， $H _ { \mathrm { [ i ] } }$ 为单位摩尔甲醇燃料的焓值， $H _ { \Xi \sqrt { 1 - 1 } }$ 为单位摩尔甲醇完全分解后合成气的焓值。

通过引入太阳能份额来反映输入系统的太阳能占总输入能量的比值，进而在一定程度上反映系统对太阳能的利用程度。

$$
F _ { \natural = \exists } = { \frac { Q _ { \natural = \lfloor } } { Q _ { \natural = \lfloor } + G _ { \natural } H _ { \natural } } }
$$
