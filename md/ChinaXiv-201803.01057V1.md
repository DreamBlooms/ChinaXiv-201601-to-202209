...
Key Words:Terapon jarbua；mtDNA control region；genetic variation；population structure
...
H102）,总体单倍型多样性（haplotype diversity， $H d$ ）为1.000,核苷酸多样性（nucleotide diversity， $P i$ ）为0.022。另外,5个群体的 $H d$ 均为 $1 . 0 0 0 ; P i$ 为0.014—0.028,详见表1。各地理群体内和群体间平均遗传距离范围在0.015—0.029之间（表2）。群体间遗传分化系数（ $\left( F s t \right)$ 在-0.014—0.041之间（ $P > 0 . 0 0 5$ ),表明群体间无明显遗传分化,基因交流频繁[21-22]。
...
Table 4Genetic diversity and genetic differentiation of the populations in Lineage A   
...
![](images/97dfbcef81db89b272c9bd1350eadbd0481bc5ed350aac911fd3788798d0015e.jpg)  
图4细鳞各分支核苷酸错配图  
Fig.4Mismatch distribution of T. jarbua of each Lineage

# 3讨论

# 3.1 细鳞的遗传多样性

判断一个群体的遗传多样性高低,常用单倍型多样性（ ${ \bf \mathcal { H } } d$ ）和核苷酸多样性 $\mathrm { ~ ( ~ } P i \mathrm { ~ ) ~ }$ 作为评价指标[25]。中国近海细鳞总体呈现出较高的遗传多样性特征（ $\left( H d \right) = 1 . 0 0 0$ ， ${ P i } = 0 . 0 2 2$ );高于同海域分布的鱼类花鲈(Lateolabrax japonicus）( $H d = 0 . 9 0 1$ ， ${ P i } \left( \overline { { = 0 . 0 0 3 } } \right) ^ { [ 2 6 ] }$ 、蓝点马鲛（Scomberomorus niphonius）( $H d = 0 . 7 0 2$ ， $P i =$ （204号0.0028）[27] 和黑鲷（Acanthopagrus schlegeli ) $( H d ) = 0 . 9 7 9$ ， $P i _ { \mathrm { \Phi } } = 0 . 0 0 9 _ { \mathrm { \Phi } } ^ { \cdot }$ [28],仅次于真鲷（Pagrosomusmajor）（ $H d = 0 . 9 9 8$ ， $P i = 0 . 0 2 5$ )[29]。表明中国近海细鳞的遗传多样性较高,具有一定的开发潜力。本研究5个群体中单倍型多样性较高(均为1.000),与Liu研究的台湾海峡细鳞高单倍型多样性相一致[9];但台湾海峡细鳞呈现出低遗传多样性的特征可能与选取的COI基因变异较为保守及研究样本数量有关。Grant 等人[30]认为高单倍型多样性和高核苷酸多样性可能是物种中存在两个分化的亚种或相互独立的种群发生了两次接触形成的,或者是种群呈现出稳定、发展壮大的模式且未经历瓶颈效应或种群扩张所致。结合中国细鳞种群动态,认为其遗传多样性高一方面可能是由3个谱系造成,另一方面可能与种群所处环境不均一性或种群生活生理特性有关[31-32]。物种的生理和生活习性是该物种在特定生态环境下经过长期的自然选择、进化的结果,表现出该物种对环境的适应性[33]。通常认为,遗传多样性较高则表明该物种对环境变化的适应能力较强[34];细鳞广泛分布于南海、东海及台湾海峡,是一种对温盐适应能力较强、能生活于河口咸淡水环境中的鱼类,因此推测复杂多变的海洋环境及较强的生活生理特征成为细鳞种群高遗传多样性的原因之一。

# 3.2细鳞的遗传分化

中国近海细鳞群体间存在3个分化显著的谱系,这种分歧发生在1.07百万年—0.24百万年前（即早-中更新世)。更新世时期出现冰期与间冰期交替的气候变化,从而对边缘海的面积和结构、生物的分布范围产生巨大的影响[35];冰期海平面的急剧下降使得边缘海之间出现陆桥导致海盆的生物群体产出隔离,促使近海鱼类谱系分化和物种形成[36-37]。但中国近海细鳞没有明显的地理结构,究其原因则可能是细鳞成鱼进入较深海域产卵,受精卵和孵化成的仔鱼均不具备游泳能力而随海流流动,幼鱼在内海港湾肥育,而成鱼则移向外海[1.3]。另外,中国沿岸流流向较为复杂(冬季从北到南流到转为夏季从南到北方向流动),黑潮的一个分支流经巴士海峡进入南海成为南海暖流,后又经台湾海峡向东北流入东海[12.38]（见图1洋流流向）,使得南海、台湾海峡及东海之间的水体交换活跃,加上海洋开放的环境中屏障较少,因而不同地理群体的细鳞其卵、幼体和成体均可随着洋流的运动进行自由扩散从而扩大分布范围,以致于地理距离相对较远的群体之间也能够进行基因交流。更新世冰期,西北太平洋大陆架形成很多隔离[39],隔离使得东海与南海间的细鳞出现了分化,但由于没有足够长的时间积累变异,再加上冰期后海平面的上升使得海域再次相连而出现二次接触而形成这种谱系结构,这种情况与南海康氏马鲛（Scomberomorus commerson）[40]谱系分化的现象相似。

# 3.3细鳞种群历史动态

中性检验以及单倍型网络图显示中国近海细鳞出现了种群扩张的情况。赵松龄等[41]认为在近 30 万年来,东海曾发生过5次海侵,海水向陆地侵人；曾从盛[42]认为在晚更新世时期,受气候的变化,闽东北沿海曾发生过4次海侵,但海侵的强度都不大,影响的范围较有限;海侵之后伴随的是持续上万至数千年时间的海退,海水退出本区域导致海平面大幅度升降波动。另外,伴随着更新世晚期气候变化导致的盐度、温度及洋流模式的改变等都可能导致细鳞群体出现扩张。结合中国近海细鳞高单倍型多样性和高核苷酸多样性的特征,可知细鳞3个分支在1.07百万年—0.24百万年前出现分化和隔离,细鳞在25.4百万年—5.06 万年前(合并谱系A的扩张时间及中国近海细鳞谱系扩张时间)出现种群扩张使得分化的谱系出现二次接触，谱系中的个体得以进行基因交流。这也解释了中国近海细鳞在系统邻接树上出现了3个分化显著的谱系但谱系间不存在明显地理结构的情况。

# 参考文献（References）:

［1］朱元鼎，张春霖，成庆泰．东海鱼类志.北京：科学出版社，1963：35-336．  
[2］王忠良，黄建盛，陈刚，张健东，刘诗亮.野生细鳞（Therapon jarbua）肌肉主要营养成分分析及评价.广东海洋大学学报，2013，33(4): 1-6.  
［3］李忠炉.北部湾口海域细鳞渔业生物学特性及开发保护策略初步研究[D].湛江：广东海洋大学，2008.  
[4]LiaoXL，YuXMongJG.GeneticdiversityofcomoncarpfrotolargestChinselkesandthYangtzeRiverrevealedbelitemarkers.Hydrobiologia，2006，568(1）：445-453.  
［5］张健东，宋蓓玲，陈刚.细鳞年龄与生长的研究.海洋科学，2002，26(7)：62-66.  
[6]KrishakumariL,VarsheyPK,GajbieSN，GovindanK,NairVR.Toxictyofsome mtasonthefishTeraponjarbua（Fokal).Indian Journal of Marine Sciences，1983,12(1):64-66.  
［7］周佳怡，章群，唐优良，余帆洋，赵爽.中国近海科鱼类系统发育初探.海洋渔业，2010,32（4)：351-355.  
[8]LavereE,CalveesteLaG,ZjoU,oeJopleetirucueofueafisilopen/closed estuaries from the wider Gulf of Aden.Marine Biology，2014，161(5）: 1113-1126.  
[9]LiuSYV,HuangIH,LiuMY,LinHD,WangFY,LiaoY.Genetic toctructureofTraponjarbuainTaiwanesewatersMrinedCoastal Fisheries: Dynamics，Management,and Ecosystem Science，2015,7(1) : 464-473.  
[10]HebertPCyskaA，allS，DewaardJologicalidentifatiosthoughAbarcodesProcedingfteyalSociety:Biological Sciences，2003，270(1512）: 313-321.  
...
[15]AljanabiSartiUnivesalndidslextractoofigualtocAforbasdhqucleicdsah1997，25(22):4692-4693.  
[16]TamuraKteerG,PetersonD,lipskiA，uarSEGA6molecularevolutioaryenetisanalysisrsionoleculariolodEvolution，2013，30(12)：2725-2729.  
