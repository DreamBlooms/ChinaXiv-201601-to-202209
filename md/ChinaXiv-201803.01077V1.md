...
Key Words:city；climate change；extreme precipitation；drainage pressure
...
式中， $R$ 为年最大降水量( $( \dim )$ $x$ 为年份； $b$ 为年最大降水量变化速度( $\mathrm { m m / a }$ ）； $\mathbf { \alpha } _ { a }$ 为回归公式截距； $\mathit { \Pi } _ { \overline { { R } } } ^ { - }$ 为年最 大降水量平均值(mm）;x为年份平均。
