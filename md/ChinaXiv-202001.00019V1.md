...
活细根生物量大部分分布于 $0 \sim 2 0 ~ \mathrm { c m }$ 或 $2 0 \sim 4 0 ~ \mathrm { c m }$ 的浅层土壤,少部分分布于 $4 0 \sim 6 0 \ \mathrm { c m }$ 的深层土壤。  
