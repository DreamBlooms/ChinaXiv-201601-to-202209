...
$\textcircled{1}$ 筛选某个领域(Area)，集成分析各国路线(Classification_l $\scriptstyle 1 = ^ { \circ }$ ‘pathway")规划中的技术(Classification $3 \mathrm { = }$ "technology")发展目标(Classification_ $2 { = }$ “need&target")的关键词、权重(Weight)和关联术语(Relative_terms)信息;
