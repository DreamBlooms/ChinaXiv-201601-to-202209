...
表示与对照组比较差异显著（ $\scriptstyle P < 0 . 0 5 { \mathrm { . } }$ ）；\*\*表示与对照组比较差异极显著（ $_ { - P < 0 . 0 1 }$ ）。表2同。
