...
<html><body><table><tr><td>引物名称 Primer name</td><td>引物序列（5’-3’） Primer sequence</td></tr><tr><td>HDR-CDS-F</td><td>ATGGCAATCTCTTTGCAATTCG</td></tr><tr><td>HDR-CDS-R</td><td>TTATGCCAGTTGCAAGGCTTC</td></tr></table></body></html>
...
<html><body><table><tr><td>Protein characteristic</td><td>GrHDR</td></tr><tr><td>氨基酸数</td><td>465</td></tr><tr><td>Number of amino acids 分子式</td><td>C2324H3642N614O720S18</td></tr><tr><td>Formula 分子质量</td><td></td></tr><tr><td>Molecular weight</td><td>52 281.25 Da</td></tr><tr><td>等电点 Isoelectric point (pI)</td><td>5.32</td></tr><tr><td>带正电的残基 (精氨酸+赖氨酸) Positively charged residues (Arg+Lys)</td><td>57</td></tr><tr><td>带负电的残基 (天冬氨酸+谷氨酸) Negatively charged residues (Asp+Glu)</td><td>71</td></tr><tr><td>不稳定系数</td><td>30.34</td></tr><tr><td>Instability index</td><td></td></tr><tr><td>脂肪系数</td><td>77.98</td></tr><tr><td>Aliphatic index</td><td></td></tr><tr><td>亲水性的平均值</td><td>-0.427</td></tr><tr><td>Grand average of hydropathicity</td><td></td></tr></table></body></html>

# 2.2.2GrHDR蛋白的结构预测

利用 SOPMA网站在线预测GrHDR蛋白的二级结构（图2)，结果显示在GrHDR蛋白中，α-螺旋，β-转角、无规卷曲、延伸链的百分比分别为 $4 5 . 1 6 \% \setminus 6 . 2 4 \% , 3 3 . 9 8 \%$ 和 $1 4 . 6 2 \%$ 。使用 EMBL-EBI数据库下pfam 程序中对GrHDR 蛋白进行结构域预测，结果显示该蛋白属于 LYTB（即 1-hydroxy- 2-methyl-2-（E）-butenyl-4-diphosphate reductase，HDR）蛋白家族。运用 SignalP5.0进行信号肽序列预测，结果显示GrHDR蛋白的信号肽的可能性为0.0006，是非分泌蛋白。运用ChloroP1.1 Server 在线预测GrHDR 蛋白转运肽长度，结果显示该蛋白含有转运肽序列为35个氨基酸残基。运用TMHMM2.0server预测GrHDR蛋白序列的跨膜结构域，结果显示该蛋白无跨膜螺旋。运用 predict protein 预测GrHDR 蛋白的亚细胞定位，结果显示该蛋白定位在叶绿体，可信度为 $71 \%$ ；使用Softberry 数据库ProtComp9.0软件预测结果显示GrHDR蛋白亚细胞定位结果为叶绿体，结果得分为9.3；不同的预测工具预测结果是相同的。

国 中50 100 150 200 250 300 350

蓝色代表α-螺旋，绿色代表β-转角，黄色代表无规卷曲，红色代表延伸链。   
Blue represents $\mathfrak { a }$ -helix, green represents $\beta$ -turn, yellow represents random curl, and red represents extended chain.

# 2.2.3三维结构的预测

运用SWISS-MODEL在线软件自动模式预测GrHDR蛋白的三级结构，所构建模型如图3所示。GMQE（全局模型质量估计）是一种质量估计，其值位于0-1之间，反映了使用该对齐和模板构建的模型的预期准确度以及目标的覆盖范围，数字越接近1表示可靠性越高，该模型的GMQE 值为0.42，可靠性一般。以超耐热菌Aquifex aeolicus4-羟基-3-甲基丁-2-烯基二磷酸还原酶（SMTLID：3dnf.1）为模板，在第 80-297氨基酸处建模，序列相似度为$3 6 . 8 6 \%$ 。

![](images/3d612bbcc712242db505e3532e173ef9f0ec550ea9a63847616373fe85e8ea28.jpg)  
图2GrHDR蛋白序列的二级结构预测结果  
Fig.2Secondary structure prediction results of GrHDR protein sequence   
图3GrHDR蛋白的三级结构模型预测结果  
Fig.3Prediction results of the tertiary structure model of the GrHDR protein

# 2.3多序列比对与系统发育分析

使用 NCBI网站的BLASTp 程序对GrHDR蛋白进行序列比对,结果表明滇龙胆GrHDR蛋白与同属植物秦芃GmHDR蛋白相似度最高（ $9 5 . 7 1 \%$ ），其次是萝芙木（Rauvolfiaverticillata）的RvHDR蛋白 $( 8 4 . 0 9 \%$ ），与长春花（Catharanthusroseus）、喜树（Camptothecaacuminata）、桂花（Osmanthus fragrans）、木樨榄（Olea europaea var. sylvestris）、黄猴花（Erythranthe gutata）、胡黄连（Picrorhiza kurrooa）等植物的HDR蛋白序列相似性也较高。运用DNAMAN对以上序列进行多序列比对，结果如图4所示。运用MEGA6.0对以上序列与GrHDR蛋白序列进行系统发育分析，结果（图5）滇龙胆GrHDR蛋白与秦苏GmHDR蛋白位于同一分支，表明它们的亲缘关系最近。

滇龙胆Gentiana rigescens (AJT35505.1) 797661369235 56 秦Gentianamacrophylla（AIP91968.1) ARL YN 萝芙木Rauvolfia verticillata（ABv89582.1） 长A   
黄猴花Erythranthe guttta(XP_012837007.1) 桂花Osmanthus fragrans(AOT86863.1)   
木榄Oleaeuropaeavar.sylvestris(XP 022860427.1) 桂花Osmanthus fragrans7AOT86862.1） ISLQ 胡黄莲Picrorhizakurrooa(ABM89226.1) Consensus masgf rc 1rs ynrgfgk 滇龙胆Gentianarigescens(AJT3550 159 萝芙木Rauvolfiaverticillata(ABv89582.1) 秦Gentianamacrophylla（AIP91968.1) S VNF NFTV 555 长春花Catharanthusroseus(ABI30631   
黄猴800 嘉树CamptothecaacuminataABI6415 153   
木樨榄Oleaeuropaeavar.sylvestris(XP_O22860427. 155 桂花Osmanthusfragrans7AOT86862.1) N 155 胡黄连Picrorhizakurrooa(ABM89226.1) 5 ISRE 156 Consensus E eysdi tW tne1 netvn 滇龙胆Gentiana rigescens (AJT35505.1) 秦艺Gentianamacrophylla（AIP91968.1) 萝美木RauvolfiaverticillataABv89582.1） 长春花Catharanthusroseus(ABI30631.1) 3G 嘉树Camptothecaacuninata(ABI64152.1)   
黄猴花花07. 233   
木樨榄Oleaeuropaeavar.sylvestris(XP_022860427.1) 桂花Osmanthusfragrans7AOT86862.1) EHEWKNEVKD PAFG DEML K VQIVDTTC YISIIHGK 胡黄莲Picrorhizakurrooa(ABM89226.1) M KNIHI S Consensus mv P gkfd gdvv dem1 k vqivdttcwvkvw ekhkkg sihgky 萝芙木Rauvolfiaverticillata(ABV89582.1) 1 3 长tA.   
黄猴花Erythranthe guttata(XP_012837007.1) 桂花Osmanthusfragrans(AOT86863.1)   
木樨榄Oleaeuropaeavar.sylvestris(XP_022860427.1 桂花Osmanthusfragrans7AOT86862.1） EET TNLKGET 胡黄连Picrorhizakurrooa(ABM89226.1) 1 Consensus eetat sfag ivknm ea dp K 滇龙胆Gentiana rigescens (AJT35505.1) 秦苏Gentianamacrophylla(AIP91968.1) 萝芙木Ravolfiverticilata（AB89582.1) GK 长春花Catharanthusroseus(ABI30631. 嘉树CamptothecaacuminataABI64152.1)   
...
![](images/57b175ecd1bad1cb9b0ec3cfc1863237ede8c561887c92cdeafbc9898fd7baf3.jpg)  
...
WANG Q, PI Y, HOU R, et al., 2008.Molecular cloning and characterization of 1-hydroxy2-methyl-2- $( E )$ -butenyl 4-diphosphate reductase (CaHDR) from Camptotheca acuminata and its functional identification in Escherichia coli[J]. BMB Rep, 41(2): 112-118.   
