...
![](images/5949cc16dc472dcc6ea08e57ba00c41e6d2d59ebb49f9d6d1ee78f2e5e4a1aa5.jpg)  
图1联盟数据可视分析模型
...
依据弧序列的大小终止，输出arc{bjj=1，Wj,i， $( x _ { j , i , m } \big | _ { m = 1 } ^ { 6 } , y _ { j , i , m } \big | _ { m = 1 } ^ { 6 } ) _ { \mathrm { ~ o ~ } }$ （20
...
![](images/1a3cbade380e333611433e18eb5ffb6e7ff0e3e609f863a81ec6477c32895387.jpg)  
图2高校联合馆中图书的层次化结构  
(b)工业技术各子类借阅比分析  
图3借阅图书与馆藏图书的对比分析
