...
$\beta$ （204号 热扩散参数, $\beta = T _ { \mathrm { w } } - T _ { \infty }$   
...
对于本文提出的热边界层发展滞后于速度边界层的热平板着火问题，主要研究存在热边界层的 $x >$
...
所以只要知道了恒温热平板着火距离 $\chi _ { \mathrm { I } }$ ，就可以由公式(33)直接计算出任意广义非加热起始段长度 $L _ { \chi }$ 条件下的着火距离 $\chi _ { \mathrm { L , I } }$
