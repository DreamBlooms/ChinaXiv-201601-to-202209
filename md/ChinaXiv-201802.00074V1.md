...
若不作特殊说明，本实验均选用 $7 \mathrm { m l }$ 、浸渍法制备、 $4 5 0 ^ { \circ } \mathrm { C }$ 煅烧的催化剂进行实验与讨论。
...
从图8中看出，在模拟烟气中通入 $\mathrm { S O } _ { 2 }$ 之后，两种催化剂的脱硝效果都呈下降趋势，说明 $\mathrm { S O } _ { 2 }$ 的存在使催化剂产生中毒现象，从而影响脱硝效率。
