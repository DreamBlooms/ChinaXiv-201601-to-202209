...
Key Words:Cadmium；monosilicic acid；rice；silicon fertilizer
...
同列数字的不同字母表示处理间差异性显著( $\scriptstyle P < 0 . 0 5 { \mathrm { ) } }$
