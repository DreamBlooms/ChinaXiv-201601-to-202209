...
$^ { + + + }$ ：优势类群 Dominant group $( > 1 0 \%$ ） $^ { + + }$ ：常见类群 Common group( $1 \% - 1 0 \%$ ） $^ +$ ：稀有类群Rare group( $( < 1 \% )$
