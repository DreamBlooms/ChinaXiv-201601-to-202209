...
与输入的 $L B P _ { n } ^ { t } ( x , y )$ 一样，极值模式映射函数、求和模式映射函数和编码模式映射函数的输出 $m L B P _ { n } ^ { t _ { 1 } } ( x , y )$ 、 $a L B P _ { n } ^ { t _ { 2 } } ( x , y )$ 和 $e L B P _ { n } ^ { t _ { 3 } } ( x , y )$ 的值也都是二元值，即0或1。
