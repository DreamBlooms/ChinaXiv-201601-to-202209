...
Chen,Lehel, Jacobson,and Shreve [3],Jia [5],Lai [6-8],Shi [16,18-20] obtained someadditional relatedresults.

Boros, Caro, Fiüredi and Yuster [2] proved an upper bound.

Theorem 2 (Boros,Caro, Füredi and Yuster [2]) For $n$ sufficiently large,
...
Proof Let $t = 1 2 6 0 r + 1 6 9 , r \geq 1$ ，h $\begin{array} { r } { n _ { t } = \frac { 2 1 1 9 } { 4 } t ^ { 2 } + 8 7 9 7 8 t + \frac { 1 5 9 5 7 } { 4 } } \end{array}$ $n \geq n _ { t }$ e $G$ $n$ $\begin{array} { l } { n + \frac { 1 0 7 } { 3 } t + \frac { 7 } { 3 } } \end{array}$ such that all cycles in $G$ have distinct lengths.

Now we construct the graph $G$ which consists of a number of subgraphs: $B _ { i }$ 5 L $0 \leq i \leq 2 0 t , 2 7 t \leq i \leq 2 8 t + 6 4 , 2 9 t - 7 3 d$ $2 9 t - 7 3 4 \leq i \leq 2 9 t + 2 6 7 , 3 0 t - 5 3 1 \leq i \ 3$ VI （20 $3 0 t + 5 7 . 3 1 t - 7 4 1 < i < 3 1 t + 5 8 . 3 2 t - 7 4 0 < i < 3 2 t + 5 7 . 3 3 t - 7 4 1 <$ 公 $\leq 3 3 t + 5 7 , 3 4 t - 7 4 1 \leq i \leq 3 4 t + 5 2 , 3 5 t$ $1 \leq i \leq 3 4 t + 5 2 , 3 5 t - 7 4 6 \leq i \leq 3 5 t + 6$ 0,36t-738≤ $\begin{array} { r } { i < 3 6 t + 6 0 . 3 7 t - 7 3 8 < i < 3 7 t + 7 9 9 . i = 2 0 t + { \mathit { i } } ( 1 < { \mathit { i } } < \frac { t - 7 } { a } ) . i = } \end{array}$ 三 $\begin{array} { r } { 2 0 t + \frac { t - 1 } { 6 } + j \big ( 1 \leq j \leq \frac { t - 7 } { 6 } \big ) , i = 2 1 t + 2 j + 1 \big ( 0 \leq j \leq t - 1 \big ) , i = 2 1 t + 2 j } \end{array}$ 2j(0≤j≤ $\begin{array} { r } { \frac { t - 1 } { 2 } ) , i = 2 3 t + 2 j + 1 ( 0 \leq j \leq \frac { t - 1 } { 2 } ) } \end{array}$ ,and $\begin{array} { r } { i = 2 0 t + \frac { t - 1 } { 6 } } \end{array}$ ， $\begin{array} { r } { i = 2 0 t + \frac { t - 1 } { 3 } + \frac { t - 1 } { 6 } - 1 } \end{array}$ ， （204 $\begin{array} { r } { i = 2 0 t + \frac { t - 1 } { 3 } + \frac { t - 1 } { 6 } } \end{array}$ ， $\begin{array} { r } { i = 2 0 t + \frac { 2 \bar { t } - 2 } { 3 } } \end{array}$ ， $i = 2 1 t - 2$ ， $i = 2 1 t - 1$ ， $i = 2 6 t$ ）
