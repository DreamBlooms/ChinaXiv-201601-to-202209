...
人工势场法是由Khatib提出的一种虚拟力法。它在机器人周围环境建立一个目标区域势能最小的虚拟势场，利用梯度下降引导机器人到达目标区域。具体为在目标区域构建一个引力势场 $U _ { a t t }$ ，并在障碍物区域构建一个斥力势场 $U _ { r e p }$ ，使得机器人被吸引向目标区域而被障碍物区域排斥。引力势函数和引力函数通常为
