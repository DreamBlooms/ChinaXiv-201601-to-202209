...
其中： $\rho ( \pmb { a } _ { 1 } , \pmb { a } _ { 2 } )$ 表示向量 $\mathbf { { a } } _ { 1 } , \mathbf { { a } } _ { 2 }$ 的相关系数被定义为
...
[1]陈琦.数字阵列雷达 DBF 处理器的降秩算法研究与实现 [D].南京： 南京理工大学,2016.   
