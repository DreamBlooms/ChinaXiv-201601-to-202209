...
表2两种疗法的平均流速（ $\mathrm { \Delta V m }$ ）估计脑血流量（ECBF）比较  
...
从表 $4 { \sim } 6$ 中可见，在脑动脉硬化症患者中实验组的疗效优于对照组（P<0.05），而且TCD和BEAM在两组间均呈现显著的差异性（ $ { \mathbf { P } } < 0 . 0 1$ ）或 $\angle$ 0.05）。
...
本项研究表明：当脑底动脉平均流速和估计脑血流量增加时，脑功能明显改善。
