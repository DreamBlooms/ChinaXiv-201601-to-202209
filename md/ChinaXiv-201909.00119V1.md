...
（4）研究区胡杨叶黄起止日及叶黄期与前3个月平均气温、所在月平均气温及所在月最高气温均呈显著的正相关,其中，胡杨叶黄起、正日与前3个月的平均气温相关系数最高，分别为0.703和0.697 ( $\alpha { \geqslant } 0 . 0 0 1$ );叶黄期与所在月平均气温的相关系数最高，为0.715（ $\alpha { \geqslant } 0 . 0 0 1$ )，表明所在月平均气温越高，叶黄期天数越长。
