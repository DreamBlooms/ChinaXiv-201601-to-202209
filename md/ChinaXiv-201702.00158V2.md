...
实际上，在正向电压较小或较大时，二极管伏安特性均会发生变化，二极管特性曲线大致如图4所示，可以分为三个区域，区域1是截止区，复合电流其主要作用，
...
一般选取的 $( \mathrm { ~ I ~ } _ { 4 } - \mathrm { ~ I ~ } _ { 3 } ) \gg ( \mathrm { ~ I ~ } _ { 2 } - \mathrm { ~ I ~ } _ { 1 } )$ ，于是，
