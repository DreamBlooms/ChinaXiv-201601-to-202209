...
通过搭建建设领域各细分行业质量控制点，使其与分部分项工程一一对应。随着施工推进，通过平台推送质量控制任务推送给相关责任人，实时指导现场施工。同时，可对施工现场发生的质量事件进行记录、上传，并将相关问题与BIM模型中构件相关联，便于及时对现场问题进行处理和整改以及日后对问题的追溯。经过一段时间的运行后，针对出现的问题，形成质量通病库，为以后的工程建设提供参考。如图6所示。
