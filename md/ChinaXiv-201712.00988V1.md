...
1.3.3 BPVSS $\mathrm { B P V S S } { = } 2 4 . 0 9 6 \cdot ~ 0 . 0 8 3 ^ { \ast }$ SBP_nightRSD- $0 . 1 3 0 ^ { * } \mathrm { a g e } \mathrm { - } 0 . 2 0 6 ^ { * } \mathrm { S B P } _ { - }$ _night_ARV(SBP_night_RSD:夜间收缩压剩余标准差,age:年龄,SBP_night_ARV：全天收缩压平均实际变异）。
