...
根据CT的测量模型(1)和最大后验(maximumaposteriori,MAP)估计方法，带有正则化项 $R \left( \mu \right)$ 的PWLS图像重建能量方程可表示为：
...
![](images/86e14379868a3c69700366c7795eb93e9579a7742cc71b7ff7fc28a396a875c6.jpg)  
