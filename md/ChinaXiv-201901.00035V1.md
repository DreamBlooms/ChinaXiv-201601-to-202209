...
a)空中航路网是一个复杂的巨系统，各航路上的费用转换为效率矩阵后会使得计算的时间复杂度很高，从而不能应用于实际的管制运行中。
...
由表5可得，随着节点数量的增大，网络规模的逐渐复杂，改进的匈牙利算法的效率优势越来越明显。
