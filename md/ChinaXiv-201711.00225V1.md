...
我们首先应从两个层面来厘清“理想智库”的概念内涵：第一个层面，什么叫智慧？什么叫智库？第二个层面，什么叫“理想智库”？
...
指的是“理想智库”的头雁优秀、实虚搭配、结构全链，具备凝才智慧、舆情智慧、结构智慧、形象智慧等素质。以人才团队为例。“理想智库”应该有这样的人才结构：能够凝心聚力的“头雁”、出类拔萃的智库专家、洞察时势并揭示趋势的战略家、攻城略地的力战者、善于打开局面的“外交家”、学者型的传播家、富有创新精神的
...
# 3.1.5智库联盟应该经常性地“华山论剑”

应效仿市场经济的办法，选择合适项目开展高透明度的市场招标，各路“神仙”聚会在一起，斗智斗法，强者上，弱者下。让“智库市

场”一潭水活起来。

# 3.1.6智库联盟的目的与功能应清晰

智库联盟，主要还是为了促进广大智库的健康发展。智库联盟的“业务评估”机制建设，应提上议事日程。在可能的情况下，可以考虑承担“第三方评估”的职能。应“高举高打”，积极参与各级智库的评价实践。

# 3.2 理想智库的素质建设

如前所述，“理想智库”是一个具有较高思想境界、价值取向正确、综合素质较高、能够影响官方和各类社会机构以及经济实体战略战术决策的智慧型社会组织。“理想智库”要真正了解各级政府、机构、企业、社会的“痒点”和“痛点”在哪里？深知“社会庸医”失误的“结节”在哪里？明白精准对症的“药方”在哪里？各类智库（党政部门、社科院、党校行政学院、高校、军队、科研院所和企业、社会）的业务区别是什么？同时，它还要明了：“理想智库”的盈利模式是什么？“业务单”从哪里来？“业务单”的接受方式有什么特点？怎样去主动“接活”（勇挑重担、争取到合理经费和必要思维劳动报酬、懂经营、善管理）？要懂得怎样组建人才结构合理的智库团队？如何物色到思维跨界、预见能力强、战略战术思维能力强、善表达、能征善战、善于容纳各类人才的谋士和执行团队？懂得怎样组建政治智囊、经济智囊、社会智囊尤其是物色到真正的“民间高人”“民间高手”？

看来，“理想智库”自身的“道痕”应该很深。本人曾在一篇阐述大数据分析与智囊关系的论文中大声疾呼：智囊们要重视自身素质的“转型升级”— 摒弃“以现象解释现象”，实现“感”的升华；摒弃“以臆断代替判断”，实现“知”的升华；摒弃“以随性充演理性”，实现“理”的升华。一流智库专家应该是在重大对策研究领域做出突破性贡献的专家学者，是细分研究领域做得最好的专家、学者，他们也应该是智库思想家。这样的专家型智囊，他的头脑会异常清醒，感会知异常灵敏，目光会异常尖锐，思维会异常缜密，剖析事理会异常到位[15]。“理想智库”要想开展有效的对策咨询，必须同时开展政治学、经济学、文化学、社会学、心理学、哲学、生态学、运筹学、管理学、甚至宗教学的交叉渗透研究与立体思考。总之，要像一些世界著名智库那样，积极介入社会，能预想课题，早做准备，不漏掉重要的发展机遇。

# 3.3 理想智库的方法论体系建设

方法，属于哲学的范畴，是指为实现某种目标而采取的手段与行为方式。联系到本话题，“智库方法论”的内涵非常丰富，广泛涉及方式、途径、步骤、手段等领域。如：定位方法、定性方法、寻轨方法、观察方法、规律方法、模型方法、模拟方法、结构方法、解析方法、比较方法、寻根方法、逻辑方法、思辨方法、归纳方法、演绎方法、直觉方法、假说方法、思辨方法、信息方法、统计方法、数理方法、整合方法、试错方法、优选方法、坐标方法、分类方法、黑箱方法、预警方法、预案方法、风暴方法、可续方法等，粗略统计至少有数百种之多。每一种方法，同时也有着更丰富的内涵。以“定位方法”

为例，稍稍解析一下我们就可以发现，它还包含着类别定位、价值定位、文化定位、功能定位、市场定位、渠道定位、工具定位、策划定位等等。除此之外，各种方法之间还可以发生更多种类的纵向、横向的交叉联系。“智库方法论”如果结合“中外智库经典案例”的深度解读将会是十分精彩的，值得我们好好涉猎、驰骋、深耕。“智库方法论”的研究成果，将会有系列的丰硕成果，如学术专著、工具书、讲义等，以及相关实践。如果与文化、艺术、产业、经营、教育等领域“嫁接”，将会有更多的收获。“智库方法论”的研究前景和实践前景，十分广阔。

# 4结束语

习近平总书记在刚刚结束的全国哲学社会科学工作座谈会上说，“一切有理想、有抱负的哲学社会科学工作者都应该立时代之潮头、通古今之变化、发思想之先声，积极为党和人民述学立论、建言献策，担负起历史赋予的光荣使命”，要有“清醒的理论自觉、坚定的政治信念、科学的思维方法”[16]。这也是习总书记对智库和智囊们的殷切期望。“理想智库”大有作为。

# The Weakness, Paths and Methods of the Construction of the Ideal Think Tanks

Liu Yuqing Jiangsu Brand Association, Nanjing 210007

Abstract: [Purpose/significance] At present, the “word of mouth effect “ of some domestic think tanks, is not ideal. Their wisdom gene is not good enough, and thinking methods are not scientific. The sustainable development of think tanks has been lacking confidence. The phenomenon above has become the focal point and one of the difficult problems of the construction of think tanks with Chinese characteristics. Therefore， the author attaches great importance to the existing problems，and pays attention to the concept and practice of the thinktank，the methodology to promote the social emergence of ideal think tanks. This has become a top priority. [Method/process] By using the multidimensional thinking and the case analysis,the author made in-depth analysis in three aspects: facing the problems, adding wisdom to contents, emphhsizing the construction of methodology. Then, the author put forward some advice for practice. [Result/conclusion] The author has made lectures on the viewpoints mentioned above in some think tanks and cultural institutions of Jiangsu Province. These lectureshave been appreciated that the views are relatively new. The perspective is relatively unique and popular, which provides inspiration as well as feasible and practical references forthe think tank construction.

Keywords: ideal think tankthe think tank of think tanks think tank coalition wisdom methodology
