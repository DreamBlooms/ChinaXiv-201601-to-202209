...
在建模方法方面，有限元分析的准确性很大程度上取决于建模过程的合理性，而骨骼材料属性的赋值是骨骼有限元分析中的关键环节，也是有限元模型计算分析
...
[1］刘长剑,罗宗键.有限元及显微有限元分析在骨科应用的新进展[J]. 大连医科大学学报，2014(2):182-5.   
