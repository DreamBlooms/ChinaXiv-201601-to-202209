# ALOWER BOUND OF THE NUMBER OF EDGES IN A GRAPH CONTAINING NO TWO CYCLES OF THESAMELENGTH

Chunhui Lai \*   
Dept. of Math., Zhangzhou Teachers College,   
Zhangzhou,Fujian 363000,P.R.of CHINA. zjlaichu@public.zzptt.fj.cn
...
for t = 27720r +169 (r ≥ 1) and n ≥ 6911t² + 514441t_ 3309665. Consequently, （204号 $\begin{array} { r } { \operatorname* { l i m } \operatorname* { i n f } _ { n \to \infty } \frac { f ( n ) - n } { \sqrt { n } } \geq \sqrt { 2 + \frac { 2 5 6 2 } { 6 9 1 1 } } } \end{array}$ （20
...
$$
\begin{array} { r l } { = } & { n - n _ { t } + 1 + \sum _ { i = 1 } ^ { 1 9 \Gamma } \frac { 7 + i } { 4 } \big ( i - 1 \big ) + \sum _ { i = 2 } ^ { i - 7 4 } \big ( 1 4 i + 1 3 i + 1 4 6 3 } \\ & { + \frac { 1 1 3 i - 1 } { 4 } + \frac { 1 3 i - 1 } { 2 } + \frac { 1 3 i - 1 } { 2 } + \frac { 1 5 i - 1 } { 4 } + \frac { 1 3 i - 1 } { 4 } + \frac { 1 4 i - 1 } { 2 } + \frac { 1 7 i - 1 } { 4 } + \frac { 1 7 i - 1 } { 2 } } \\ & { + \frac { 1 9 2 - 1 } { 2 } + \frac { 1 9 2 - 1 } { 2 } + \frac { 2 1 7 - 1 } { 4 } + \frac { i - 2 9 1 } { 2 } \big ) + \sum _ { i = 2 } ^ { i - 7 4 } \big ( 1 9 i + 2 ^ { i } + 1 \big ) } \\ & { + \sum _ { i = 1 , i = 1 } ^ { 2 i \Gamma } \frac { 1 6 } { 1 6 } \big ( i - 1 \big ) + \sum _ { j = 2 } ^ { i - 8 } \big ( 1 2 i + 1 1 i + 8 9 3 } \\ & { + \frac { 1 1 6 - 1 } { 2 } + \frac { 1 3 i - 1 } { 2 } + \frac { 1 5 i - 1 } { 2 } + \frac { 1 5 i - 1 } { 2 } + \frac { 1 5 i - 1 } { 2 } + \frac { 1 7 i - 1 } { 2 } + \frac { 1 7 i - 1 } { 2 } } \\ & { + \frac { 1 8 i - 1 } { 2 } + \frac { 1 9 2 - 1 } { 2 } + \frac { 2 1 6 } { 2 } - \frac { 1 } { 2 } \big ) + \sum _ { i = 2 } ^ { i - 9 } \frac { 4 } { 2 } } \\ & { + \sum _ { i = 2 } ^ { i - 3 2 i + 2 \Gamma } \frac { 7 + i } { 4 } \big ( i - 1 \big ) + \sum _ { j = 2 } ^ { i + 6 } \frac { 7 } { 2 } \frac { 1 } { 2 } } \\ & { + \sum _ { i = 2 } ^ { i - 6 } \frac { 1 } { 2 } \frac { 1 } { 6 } \big ( i - 1 \big ) + \sum _ { i = 2 } ^ { 2 i + 6 } \frac { 7 + 1 } { 2 } + \sum _ { i = 3 } ^ { i - 1 6 } \frac { 1 } { 2 } ( i - 1 ) } \\ & { + \sum _ { i = 2 } ^ { i - 6 } \frac { 1 } { 2 } \frac { 1 } { 6 } \big ( i - 1 \big ) + \sum _ { i = 2 } ^ { i - 6 } \frac { 1 } { 2 } \frac { 1 } { 6 } \big ( i - 1 \big ) } \\ &  + \sum _ { i = 2 } ^ { i - 6 } \frac { 1 } { 2 } \frac { 1 } { 6 } \big ( i - 1 \big ) + \sum _  i  \end{array}
$$

Now we compute the number of edges of $G$

$$
\begin{array} { r l } { \gamma _ { 1 } ( G ) ^ { * } = } & { \gamma  \mathbf { B } _ { 2 }  + \sum _ { j = 1 } ^ { \infty } \frac { 1 } { \gamma _ { 2 } \gamma _ { 1 } } \sum _ { k = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 }  \sum _ { i = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 }  + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 }  \sum _ { i = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 }  ) , } \\ & { + \sum _ { j = 1 } ^ { \infty } \frac { 1 } { \gamma _ { 2 } \gamma _ { 2 } }  \mathbf { B } _ { 2 }  + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 }  + \sum _ { i = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 }  ) } \\ & { + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) \exp ( \mathbf { B } _ { 2 } ) - \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) \exp ( \mathbf { B } _ { 2 } ) } \\ & { + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) \exp ( \mathbf { B } _ { 2 } ) - \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) } \\ & { + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) \exp ( \mathbf { B } _ { 2 } ) } \\ & { + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) } \\ & { + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) \exp ( \mathbf { B } _ { 2 } ) } \\ & { - \sum _ { k = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) + \sum _ { k = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) } \\ &  - \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) + \sum _ { j = 1 } ^ { \infty } \exp ( \mathbf { B } _ { 2 } ) + \sum _  j =  \end{array}
$$
...
[1] J.A. Bondy and U.S.R. Murty， Graph Theory with Applications (Macmilln， New York,1976).   
