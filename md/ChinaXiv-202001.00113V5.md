...
值得注意的是，贝叶斯估计本身是基于数据进行模型拟合的过程，因此研究者可以使用不同的先验'和不同的模型。在这个过程中，需要考虑先验分布设定的合理性以及 MCMC 抽样收敛(convergence)，具体可以参考Depaoli 和 Schoot (2017)。
...
![](images/77dd894a1e9b14e46e914f89c8b3ad14a27fe8887e90145c4316b6aec286a771.jpg)
