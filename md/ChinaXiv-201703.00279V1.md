...
首先，我们建立一个空间几何模型，得到一组已知位置的控制点，然后，通过对建立的空间几何模型成像得到存在畸变的控制点的位置，建立两组控制点之间的映射关系，得到表征正确的控制点的位置的多项式：
...
![](images/349116c4053c633f9d8d298aa3cf741a14677c36d1b5dc9dbce8f1fef4c404bf.jpg)  
图6修正后小孔图像
