...
7将 $5 \times { 1 0 } ^ { 6 }$ 个肿瘤细胞皮下接种到裸鼠的腋下区域每组5只小鼠）。然后每3\~5天测量皮下肿瘤大小，并计算体积。所有动物实验都在动物护理和使用委员会的批准下进行。
...
# Fig.2The effect of PHP14 knockdown on apoptosis of lung caner cells
