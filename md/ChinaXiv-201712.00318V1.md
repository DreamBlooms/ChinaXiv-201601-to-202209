# 变电站工程施工管理中的BIM应用与实践-以泰州文东高山220KV变电站为例
...
在本项目中通过BIM来辅助进度计划的编制以及进度计划的执行，将进度计划、现场实施情况与BIM模型进行深度关联，在BIM模型中实时反映现场施工情况与计划进度的对比，及时进行项目的进度的纠偏，有效把控项目进度计划的实施。
