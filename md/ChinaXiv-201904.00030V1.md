...
由算法1和2可知节点在博弈过程中存在相应的信任值$T _ { i }$ ，又根据全局阈值法求出了节点的最优动态阈值 $\varepsilon$ 。之后将得到的节点信任值 $T _ { i }$ 与动态阈值 $\varepsilon$ 进行比较，判定节点 $N$ 是否为可疑恶意车辆节点，即
...
![](images/9414418a17d89142f698e7900b4eb2167d1ecde8462cf2464eb649ae0a06eef5.jpg)  
