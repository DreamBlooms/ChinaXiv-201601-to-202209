...
The magnetic theory requires the existence of meson-like composites to satisfy the anomaly matching conditions. Components of the meson fields $\tilde { M }$ from $Q ^ { T } , Q ^ { D } , Q ^ { S }$ and $\tilde { Q } ^ { T } , \tilde { Q } ^ { D } , \tilde { Q } _ { S }$ composition can be decomposed in terms of $S U ( 3 ) _ { 2 } \times S U ( 2 ) _ { L } \times U ( 1 ) _ { Y }$ as
...
We also introduce the right-handed top quark chiral supermultiplets in terms of gauge group $S U ( 3 ) _ { 2 } \times S U ( 2 ) _ { L } \times U ( 1 ) _ { Y } \times U ( 1 ) _ { 1 }$ quantum number
...
After performing the Fierz rearrangement and at the leading order in $1 / N _ { c }$ ，we have
...
The analytical expressions are very complicate. Careful analysis indicates that the three mass eigenvalues are of order
...
$$
\begin{array} { l } { { \displaystyle { \mathcal { L } } _ { \mu } = - \lambda _ { 1 } \dot { \bar { t } } _ { L } ^ { m } \ell _ { R } ^ { m } + \frac { h _ { 2 } M } { \sqrt 2 } U _ { B } ^ { - 1 } \bar { t } _ { L } ^ { m } U _ { R 1 1 } ^ { - 1 } \ell _ { R } ^ { m } h _ { 0 } + \frac { h _ { 2 } M } { \sqrt 2 M _ { B } } U _ { L 2 1 } ^ { - 1 } \bar { t } _ { L } ^ { m } U _ { R 3 1 } ^ { - 1 } \ell _ { R } ^ { m } \tilde { S } _ { 2 } } }  \\ { { \displaystyle ~ + \frac { h _ { 2 } M } { \sqrt 2 M _ { B } } U _ { L 3 1 } ^ { - 1 } \bar { t } _ { L } ^ { m } U _ { R 3 1 } ^ { - 1 } t _ { R } ^ { m } \tilde { S } _ { 3 } + \frac { 1 } { 2 } Z _ { h _ { 0 } } ( \partial _ { \mu } h _ { 0 } ) ^ { 2 } + \frac { 1 } { 2 } \sum _ { i } \sum _ { S _ { i } } \mathcal { S } _ { i } ( \partial _ { \mu } S _ { i } ) ^ { 2 } + \sum _ { i } Z _ { \Delta i } | \partial _ { \mu } \Delta _ { i } | ^ { 2 } } } \\ { { \displaystyle ~ - \frac { 1 } { 2 } \left( M _ { h _ { 0 } } ^ { 2 } h _ { 0 } ^ { 2 } + \sum _ { i } M _ { S _ { i } } ^ { 2 } S _ { i } ^ { 2 } \right) - \sum _ { i } M _ { \Delta _ { i } } ^ { 2 } | \Delta _ { i } ^ { 2 } | ^ { 2 } - \sum _ { i } M _ { i 0 } S _ { i } h _ { 0 } } } \\ { { \displaystyle ~ - \tilde { M } _ { 2 3 } S _ { 2 } S _ { 3 } - M _ { 2 3 } \Delta _ { 2 } \Delta _ { 3 } - V ( h _ { 0 } , S _ { i } , \Delta _ { i } ) - \Delta T _ { h _ { 0 } } h _ { 0 } - \sum _ { i } \Delta T _ { S _ { i } } S _ { i } , ~ } } \end{array}
$$
...
Here the expression for the lightest bottom-type quark mass is not precise. This formula is used to determine the order of the physical bottom mass.We can also parameterize the mixings in the bottom sector as
...
while $\mu _ { S _ { 2 } }$ and $\mu _ { S _ { 3 } }$ are
...
From the Pagels-Stokar formula and setting $v _ { t } ^ { 2 } \simeq ( 2 0 0 \mathrm { G e V } ) ^ { 2 }$ and $N _ { c } = 3$ ，we obtain the cut-off scale
...
$$
\begin{array} { l } { { M _ { 2 3 } ^ { S S } = \displaystyle \frac { F _ { 2 3 , 3 3 } ^ { T T } + F _ { 2 3 , 3 3 } ^ { B B } } { \sqrt { Z _ { S _ { 2 } } Z _ { S _ { 3 } } } } ~ , M _ { 2 4 } ^ { S S } = \displaystyle \frac { F _ { 2 3 , 4 1 } ^ { B B } } { \sqrt { Z _ { S _ { 2 } } Z _ { S _ { 4 } } } } ~ , M _ { 2 5 } ^ { S S } = \displaystyle \frac { F _ { 2 3 , 4 5 } ^ { B B } } { \sqrt { Z _ { S _ { 2 } } Z _ { S _ { 5 } } } } ~ , } } \\ { { M _ { 2 6 } ^ { S S } = \displaystyle \frac { F _ { 2 3 , 5 5 } ^ { B B } } { \sqrt { Z _ { S _ { 2 } } Z _ { S _ { 6 } } } } ~ M _ { 3 4 } ^ { S S } = \displaystyle \frac { F _ { 3 3 , 4 1 } ^ { B B } } { \sqrt { Z _ { S _ { 3 } } Z _ { S _ { 4 } } } } ~ , M _ { 3 5 } ^ { S S } = \displaystyle \frac { F _ { 3 3 , 4 5 } ^ { B B } } { \sqrt { Z _ { S _ { 3 } } Z _ { S _ { 5 } } } } ~ , } } \\ { { M _ { 3 6 } ^ { S S } = \displaystyle \frac { F _ { 3 3 , 5 5 } ^ { B B } } { \sqrt { Z _ { S _ { 3 } } Z _ { S _ { 6 } } } } ~ , M _ { 4 5 } ^ { S S } = \displaystyle \frac { F _ { 4 1 , 4 5 } ^ { B B } } { \sqrt { Z _ { S _ { 4 } } Z _ { S _ { 5 } } } } ~ , M _ { 4 6 } ^ { S S } = \displaystyle \frac { F _ { 4 1 , 5 5 } ^ { B B } } { \sqrt { Z _ { S _ { 4 } } Z _ { S _ { 6 } } } } ~ , } } \end{array}
$$

the $h _ { i }$ and $S _ { j }$ mixing terms are

$$
\begin{array} { r l } & { \mathrm { \Delta } \dot { q } _ { 0 2 } ^ { R , S } = \frac { \Gamma _ { 0 2 , 3 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 5 } } , \ \mathrm { \Delta } M _ { 1 0 } ^ { R , S } = \frac { \Gamma _ { 0 2 , 0 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 3 } } , \ \mathrm { \Delta } M _ { 1 5 } ^ { R , S } = \mathcal { M } _ { 1 5 } = \mathcal { M } _ { 1 6 } = 0 \ , \ \mathcal { M } _ { 1 6 } ^ { R , S } = \frac { \Gamma _ { 0 2 , 0 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 4 } } , \ } \\ & { \mathrm { \Delta } \dot { q } _ { 1 1 } ^ { R , S } = \mathrm { \Delta } , \ \frac { \Gamma _ { 0 3 , 3 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } } , \ \mathrm { \Delta } M _ { 1 6 } ^ { R , S } = \frac { \Gamma _ { 0 3 , 1 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 4 } } , \ \mathrm { \Delta } M _ { 1 6 } ^ { R , S } = \frac { \Gamma _ { 0 1 , 8 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 5 } } , \ \mathrm { \Delta } M _ { 1 8 } ^ { R , S } = - \frac { \Gamma _ { 0 1 , 3 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 5 } } , } \\ & { \mathrm { \Delta } \dot { q } _ { 2 2 } ^ { R , S } = \frac { \Gamma _ { 0 6 , 2 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 5 } } , \ \mathrm { \Delta } M _ { 2 5 } ^ { R , S } = \frac { \Gamma _ { 0 6 , 0 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 5 } } , \ \mathrm { \Delta } M _ { 2 5 } ^ { R , S } = \frac { \Gamma _ { 0 6 , 0 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 5 } } , \ \mathrm { \Delta } M _ { 2 5 } ^ { R , S } = \frac { \Gamma _ { 0 6 , 0 5 } ^ { R , 1 5 } } { \sqrt { 2 } \kappa _ { 1 2 , 5 } \Gamma _ { 0 6 } } , \ } \\ &  \mathrm { \Delta } \dot { q } _ { 2 0 } ^ { R , S } = \frac { \Gamma _ { 0 6 , 0 5 } ^ { R , 1 5 } }  \sqrt { 2 } \kappa _  \end{array}
$$

and the relations are

$$
M _ { i j } ^ { h S } = \frac { { F _ { a b , c d } ^ { T T , B B } } } { \sqrt { Z _ { h _ { i } } Z _ { S _ { j } } } } \ , \ M _ { j i } ^ { h S } = \frac { { F _ { c d , a b } ^ { T T , B B } } } { \sqrt { Z _ { S _ { i } } Z _ { h _ { j } } } } \ .
$$

# 7 Appendix C: Oblique Parameters

The most important constraints of out model is the oblique parameters. New contributions to the $T$ parameter

$$
T = \frac { 4 \pi } { \sin ^ { 2 } \theta \cos ^ { 2 } \theta M _ { Z } ^ { 2 } } \left[ \Pi _ { 1 1 } \left| _ { q ^ { 2 } = 0 } - \Pi _ { 3 3 } \right| _ { q ^ { 2 } = 0 } \right] \ ,
$$

from the quark sector are

$$
\begin{array} { r l } { \mathcal { H } ^ { \mathrm { T } } = \displaystyle \sum _ { \ell = 1 } ^ { N } \frac { 1 } { \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } } \left( \frac { \lambda ^ { 2 } } { 2 } \sum _ { \ell = 1 } ^ { N } \left[ \sum _ { i = 1 } ^ { N } \frac { \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } } { 2 } \right] ^ { \ell } \left[ \sum _ { \ell = 1 } ^ { N } \frac { \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } } { 2 } \right] ^ { \ell } \right) \Bigg | \Delta \nu _ { \ell } - \nu _ { \ell } \Bigg | } \\ { + } & { \sum _ { \ell = 1 } ^ { N } \frac { 1 } { \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } } \Bigg [ \Bigg [ \sum _ { \ell = 1 } ^ { N } \frac { \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } } { 2 } \Bigg ] \Bigg [ \sum _ { \ell = 1 } ^ { N } \frac { \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } + \nu _ { \ell } ^ { 2 } } { 2 } \Bigg ] ^ { \ell } \Bigg ] ^ { \ell } \Delta \nu _ { \ell } - \nu _ { \ell } \Bigg | } \\ { + } & { \sum _ { \ell = 1 } ^ { N } \Bigg [ \bigg ( \sum _ { \ell = 1 } ^ { N } \nu _ { \ell } \bigg ) \Delta \nu _ { \ell } + \bigg ( \sum _ { \ell = 1 } ^ { N } \nu _ { \ell } \bigg ) \Bigg ] ^ { \ell } \Bigg | \Delta \nu _ { \ell } \frac { \nu _ { \ell } ^ { 2 } } { 2 } } \\ { - } & { \sum _ { \ell = 1 } ^ { N } \Bigg [ \bigg ( \sum _ { \ell = 1 } ^ { N } \nu _ { \ell } \bigg ) \Delta \nu _ { \ell } + \bigg ( \sum _ { \ell = 1 } ^ { N } \nu _ { \ell } \bigg ) \Bigg ] ^ { \ell } \Bigg | \Delta \nu _ { \ell } \frac { \nu _ { \ell } ^ { 2 } } { 2 } } \\  - \sum _ { \ell = 1 } ^ { N } \bigg ( \sum _ { \ell = 1 } ^ { N } \nu _ { \ell } \bigg ) \Bigg | \Delta \nu _ { \ell } \frac { \nu _ { \ell } ^ { 2 } } { 2 } \Bigg | \Delta \nu _ { \ell } \frac { \nu _ { \ell } ^ { 2 } } { 2 } \Bigg | \Delta \nu _ { \ell } \frac  \nu _  \ell  \end{array}
$$

here we define

$$
\begin{array} { l } { { { \displaystyle { \cal K } ( a , b ) \equiv \frac { 1 } { a ^ { 2 } - b ^ { 2 } } \left[ \frac { a ^ { 4 } } { 2 } \ln \frac { a ^ { 2 } } { M _ { B } ^ { 2 } } - \frac { b ^ { 4 } } { 2 } \ln \frac { b ^ { 2 } } { M _ { B } ^ { 2 } } - \frac { 1 } { 4 } a ^ { 4 } + \frac { 1 } { 4 } b ^ { 4 } \right] ~ , } } } \\ { { { \displaystyle { \cal L } ( a , b ) \equiv \frac { a b } { a ^ { 2 } - b ^ { 2 } } \left[ a ^ { 2 } \ln \frac { a ^ { 2 } } { M _ { B } ^ { 2 } } - b ^ { 2 } \ln \frac { b ^ { 2 } } { M _ { B } ^ { 2 } } - a ^ { 2 } + b ^ { 2 } \right] ~ . } } } \end{array}
$$

New contributions to the oblique $S$ parameter

$$
S = 1 6 \pi \left[ \frac { \partial } { \partial q ^ { 2 } } \Pi _ { 3 3 } \left| _ { q ^ { 2 } = 0 } - \frac { \partial } { \partial q ^ { 2 } } \Pi _ { 3 Q } \right| _ { q ^ { 2 } = 0 } \right] ,
$$

from the quark sector are

$$
\begin{array} { r l } { \iota _ { 1 , 2 } ^ { \mathrm { o u t } } } &  = 1 , \frac { 1 } { 2 } [ \sum _ { i \in \mathcal { I } _ { i } } \sum _ { j \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _ { \ell \in \mathcal { I } _ { i } } \sum _  \ell \in \mathcal { I } _ \end{array}
$$

withthedefinition

$$
\begin{array} { l } { { \displaystyle P ( a , b ) = \int _ { 0 } ^ { 1 } x ( x - 1 ) \ln [ ( a - b ) x + b ] d x ~ , } } \\ { { \displaystyle Q ( a , b ) = \int _ { 0 } ^ { 1 } \frac { x ( x - 1 ) } { ( a - b ) x + b } d x ~ , } } \end{array}
$$
...
[1] Y. Nambu, Proc. of 1988 Int. Workshop "New Trends in Strong Coupling Gauge Theories", Nagoya, Japan, Aug 24 - 27,(1988).

W.A.Bardeen,C. T.Hill, M.Lindner, Phys.Rev .D 41:1647(1990). V.A.Miransky, M. Tanabashi,K. Yamawaki,Phys. Lett. B221:177(1989). [2] Christopher T. Hill, Phys. Lett.B 345:483-489(1995). K.Lane,E. Eichten, Phys. Lett.B 352:382(1995). [3] A.Dobrescu, C. T. Hill, Phys.Rev. Lett.81:2634(1998). R.S. Chivukula,A. Dobrescu, H. Georgi, C. T. Hill, Phys. Rev.D 59: 075003(1999). [4] G.'t Hooft, Recent Developments in Gauge Theories,Plenum, New York,1980, p.135. [5]N.Seiberg,Nucl. Phys. 5435(1995）129. N. Seiberg,Int.J. Mod.Phys.A 16（2001) 4365. [6] G. Aad et al. [ATLAS Collaboration], arXiv:1207.7214 [hep-ex]. [7] S. Chatrchyan et al. [CMS Collaboration],arXiv:1207.7235 [hep-ex]. [8] Kenneth Intriligator,Nathan Seiberg,David Shih, JHEP O604:021,2006. [9] Hitoshi Murayama, Yasunori Nomura, Phys. Rev. Lett. 98:151803(2007); Hitoshi Murayama, Yasunori Nomura, Phys. Rev. D 75:095011(2007). [10] A.E. Nelson,N. Seiberg,Nucl. Phys.B 416(1994)46. [11] Hsin-Chia Cheng, Christopher T. Hill, Jing Wang,Phys. Rev. D64(2001)095003. [12] G.F. Giudice and R. Rattazzi, Nucl. Phys. B511, 25(1998). [13] Hong-Jian He, Christopher T.Hill, T. Tait,Phys. Rev. D65:055006(2002). [14] R. S. Chivukula,A.G. Cohen, E.H. Simmons, Phys.Lett.B 380:92(1996); Marko B. Popovic, E. H. Simmons,Phys. Rev. D 58:095007(1998). [15] Michael E. Peskin, Tatsu Takeuchi, Phys.Rev.Lett 65:964(1990); Michael E. Peskin, Tatsu Takeuchi, Phys. Rev. D 46:381(1992). [16] L. Randall, R. Sundrum,Phys. Rev. Lett. 83,337O(1999).