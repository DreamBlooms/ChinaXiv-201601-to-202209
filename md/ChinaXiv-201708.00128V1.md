...
where $\begin{array} { r } { D ^ { \mu } \phi = \partial ^ { \mu } \phi - i \frac { g _ { \phi } } { 2 } \tau \cdot V ^ { \mu } } \end{array}$ . The hidden gauge coupling $g _ { \phi } < 4 \pi$ ， required by the unitarity bound, need to be hold for any thermal particle whose relic density arises from the freeze-out of its annihilation [39, 45, 46]. In particular, $b _ { 1 }$ and $a _ { 1 }$ terms break the global （20 $U ( 1 )$ symmetry explicitly. In the SM Lagrangian, the Higgs potential notations are defined as: $\begin{array} { r } { \mathcal { L } ^ { S M } \ni - ( m ^ { 2 } / 2 ) H ^ { \dag } H - \lambda ( H ^ { \dag } H ) ^ { 2 } } \end{array}$ with $H = ( 0 , v + h ) / \sqrt { 2 }$ ，where $v$ is the VEV of the Higgs field.

After the $S U ( 2 ) _ { D }$ being spontaneously broken, both $\phi$ and the singlet ${ \mathbb S }$ get the VEVs:
...
$c$ ， $s$ and their subscripts 1,2,3 represent cos,sin, $\theta _ { 1 2 }$ ， $\theta _ { 2 3 }$ ，and $\theta _ { 1 3 }$ individually
...
![](images/d4707e495c1050615672115df8b14b106d6ae92ebd90bee3fee3162aea1a564b.jpg)  
...
![](images/754bc1d5af9dd490e2a8da2c77e7e10935dadef2956d39aa72f19aa8944db81a.jpg)  
...
![](images/ab06c42052b2be535c31a9c2cc211d4e6d13586a7a4bcf51f09ec108e66369ef.jpg)  
...
![](images/b8d23e09928843a93ba02c0ac390e7898a97ef58d14ef45e9479dbe08c7b303d.jpg)  
...
![](images/803e76a0a969098f205f5845a72f7bb7a5cea28bd52aba528bb7728da4cce02b.jpg)  
...
![](images/b9e553313364048ba48817b776292a6c4311df38e29dc22b7e836a0abee7b454.jpg)  
Figure 6. Plots of the total relic density $\Omega _ { A } h ^ { 2 } + \Omega _ { V } h ^ { 2 }$ for the case of $m _ { A } > m _ { V }$ and $m _ { V } > m _ { A }$

![](images/a4bbdb5d08bf71bd42c5b9be504bcdbbfce33ee40a27686def5a3e5e6f53497e.jpg)  
...
In this section,we study the effects of the mixing among the three fields $h , \ \eta ^ { \prime }$ ， $S$ using the Higgs indirect search and constraints from electroweak precision observables.
...
The presence of the scalar $h _ { 3 }$ with mass $m _ { h _ { 3 } } < 1 1 4$ GeV is subject to tight bounds from the LEP [58],while these bounds are highly released in all our parameter choices， since the mixing between $h _ { 1 }$ and $h _ { 3 }$ is very small, about O.O573 for benchmark scenario given in Table.1 and could be seen in the Fig. 12 for the benchmark scenario given in Table. 2.
...
![](images/820783e986b56383d6f5d5548a566c62d948858e645fae63634caa05d2bac405.jpg)  
Figure 12. $R$ values with respect to $\lambda _ { m }$ and $\delta _ { 2 }$

$$
\begin{array} { r l } & { S = \cfrac { 1 } { 2 4 \pi } \{ \vphantom { \int } } \frac { \mathrm { d } x _ { 1 1 } } { \mathrm { R e } ^ { 2 } \mathrm { f } } [ \Theta x _ { 1 1 } [ \mathrm { e g } _ { 1 6 , 1 6 } + C ( m _ { 3 1 } ^ { 2 } , m _ { 2 2 } ^ { 2 } ) - C ( m _ { 3 1 } ^ { 2 } , m _ { 3 2 } ^ { 2 } ) ]   \\ & {  \qquad + R _ { 1 2 } ^ { 2 } [ \mathrm { i } \Theta _ { 6 6 , 6 9 } + C ( m _ { 4 2 } ^ { 2 } , m _ { 2 2 } ^ { 2 } ) - C ( m _ { 4 2 } ^ { 2 } , m _ { 3 2 } ^ { 2 } ) ]  } \\ & {  \qquad + R _ { 2 3 } ^ { 2 } [ \mathrm { l o g } _ { 1 6 , 3 6 } + C ( m _ { 4 3 } ^ { 2 } , m _ { 2 2 } ^ { 2 } ) - C ( m _ { 3 1 } ^ { 2 } , m _ { 2 2 } ^ { 2 } ) ] \} , } \\ & { T = \cfrac { 3 } { 1 6 \pi \sqrt { 3 } \mathrm { i } ^ { 2 } \mathrm { \Theta } _ { 6 6 } } \{ R _ { 1 1 } ^ { 2 } [ \frac { 1 } { \mathrm { S o } ^ { 2 } \mathrm { f } _ { 1 1 } } ( \frac { \mathrm { d } \mathrm { Q } _ { 8 6 } \mathrm { R e } ^ { 2 } \mathrm { f } _ { 2 1 } } { 1 - R _ { 2 2 4 } } - \frac { \mathrm { l o g } _ { 4 6 } \mathrm { R e } \mathrm { f } _ { 2 1 } } { 1 - R _ { 2 2 4 } } ) - ( \frac { \mathrm { d } \mathrm { Q } _ { 8 6 } \mathrm { R e } \mathrm { f } _ { 8 1 } } { 1 - R _ { 1 6 } \mathrm { T r } _ { 1 6 } } - \frac { \mathrm { l o g } _ { 4 6 } \mathrm { R e } } { 1 - R _ { 1 6 } \mathrm { T r } _ { 1 6 } } ) ]  } \\ &   \qquad + R _ { 1 2 } ^ { 2 } [ \frac { 1 } { \mathrm { c o } ^ { 2 } \mathrm { f } _ { 0 6 } } ( \frac { \mathrm { l o g } _ { 1 6 } \mathrm { R e } \mathrm { f } _ { 2 2 } } { 1 - R _ { 2 2 } } - \frac { \mathrm { l o g } _ { 1 6 } \mathrm { R e } \mathrm { f } _ { 2 2 } } { 1 - R _ { 2 2 } } ) - ( \frac { \mathrm { l o g } _ { 1 6 } \mathrm { R e } \mathrm { f } _ { 3 1 } } { 1 - R _ { 1 6 } \mathrm { T r } _ { 1 6 } } - \frac { \mathrm { l o g } _ { 1 6 } \mathrm { R e } \mathrm { f } _ { 1 6 } }  1 - R _ { 1 6 } \mathrm \end{array}
$$
...
$$
\begin{array} { r l } & { G ( m _ { A } ^ { 2 } , m _ { B } ^ { 2 } ) = - \frac { 7 9 } { 3 } + 9 R _ { A B } - 2 R _ { A B } ^ { 2 } + ( 1 2 - 4 R _ { A B } + R _ { A B } ^ { 2 } ) f ( R _ { A B } ) } \\ & { \quad \quad + ( - 1 0 + 1 8 R _ { A B } - 6 R _ { A B } ^ { 2 } + R _ { A B } ^ { 3 } - 9 \frac { R _ { A B } + 1 } { R _ { A B } - 1 } ) \log R _ { A B } , } \\ & { f ( R _ { A B } ) = \left\{ \begin{array} { l l } { \sqrt { R _ { A B } ( R _ { A B } - 4 ) } \log \left| \frac { R _ { A B } - 2 - \sqrt { R _ { A B } ( R _ { A B } - 4 ) } } { 2 } \right| R _ { A B } > 4 , } \\ { \quad \quad 0 \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad R _ { A B } = 4 , } \\ { 2 \sqrt { R _ { A B } ( 4 - R _ { A B } ) } \arctan \sqrt { \frac { 4 - R _ { A B } } { R _ { A B } } } \quad \quad \quad R _ { A B } < 4 . } \end{array} \right. } \end{array}
$$

The parameters set is given in Table 2 and the magnitude of $g _ { \phi }$ is determined by $m _ { V }$ and $v _ { \phi }$ . The constraints on two parameters $\delta _ { 2 }$ and $\lambda _ { m }$ from $S$ and $T$ parameters are shown in Fig.13. The $S$ and $T$ constraints require that $\delta _ { 2 }$ and $\lambda _ { m }$ should be smaller than about 0.45 and O.06 respectively. $S$ and $T$ are very sensitive to the mixing effects. The frst two parameter groups (as given in Section 3.1) does not change the mixing angles among $h , \eta ^ { \prime } , S$ ，and $S$ and $T$ give rise to the null limits since the mixing effects among $h$ and $\eta ^ { \prime }$ ， $S$ in that cases are very small.

![](images/ee460711797b363aaf3c8c2d921a1b53b9e19380f33b146e4c7c1e4b648fe030.jpg)  
...
To figure out to what extent we need to lift the value of the Higgs quartic coupling in the third parameters setup (as given in Table 2)，we plot contours of $\lambda ( \mu = 1 0 ^ { 9 } ~ ( 1 0 ^ { 1 8 } )$ （204号

![](images/9f10f50ec8f83b9199db8a61d1f7342aa74bc7082da2f0dc0eaf1cdb2f123f85.jpg)  
...
![](images/d750807c48b978e0589b7f4d8ca61bdf60d7a564cce0f610ec1022a3c5bf1d4a.jpg)  
...
![](images/1087a2f57ed0910c304d846c2b59e157fe569d38a98db77457834d780edf4610.jpg)  
Figure 16. $\lambda ( 1 0 ^ { 9 } \mathrm { G e V } )$ as a function of $\delta _ { 2 }$ and $\lambda _ { m }$ ： $n = 2$ is to indicate we have supplemented two （20 $\mathbb { S }$ ：
...
and $m _ { h } \ ( m _ { h } ^ { 0 } )$ is the renormalized (bare) Higgs mass, $\Lambda$ indicates the cut off scale where the new fields are required to cancel the quadratic divergences of the Higgs mass square.
...
Below the scale of electroweak symmetry breaking, Eq. (6.6) leads to a shift in the wavefunctioeafa $h$ [9].with $\delta Z _ { h } = 2 v ^ { 2 } ( c _ { H } ^ { \eta ^ { \prime } } / m _ { \eta ^ { \prime } } ^ { 2 } + c _ { H } ^ { S } / m _ { S } ^ { 2 } +$ $c _ { H } ^ { A } / m _ { A } ^ { 2 } )$ . After canonically normalizing $h$ ,i.e., $h  ( 1 - \delta Z _ { h } / 2 ) h$ , its coupling to vectors and fermions are altered, which may lead to a measurable correction to,e.g., the $h Z$ associated production cross-section
...
$$
\begin{array} { r l } { \zeta ( \theta ^ { * } ) ( \theta ^ { * } ) ( \theta ^ { * } ) } &  = \frac { \lambda _ { 1 } ^ { 2 } } { 1 2 \Theta ^ { 2 } } \left. \frac { 1 } { \Theta } - \frac { \lambda _ { 2 } ^ { 2 } } { \Theta ^ { 2 } } \left( \frac { \lambda _ { 1 } } { 1 + \Theta ^ { 2 } } \frac { \lambda _ { 2 } ^ { 2 } } { \Theta ^ { 2 } } \right) ^ { 2 } \right. - \frac  \lambda _ { 1 } ^ { 2 } \Theta ^ { 2 } \lambda _ { 2 } ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \Theta ^ { 2 } \ \end{array}
$$

$$
\begin{array} { r l } & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \quad \quad \quad \quad \quad \quad \quad  \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad  \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad  \\ &  \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad  \end{array}
$$
...
$$
\begin{array} { l } { { < \sigma v > _ { V V  h _ { a } h _ { a } } ^ { t + u } = \displaystyle \frac { 1 } { 4 \pi } \displaystyle \frac { 1 } { m _ { V } ^ { 2 } } \sqrt { 1 - \frac { m _ { h _ { a } } ^ { 2 } } { m _ { V } ^ { 2 } } | \frac { ( g _ { \phi } ^ { 2 } v _ { \phi } ) ^ { 2 } } { m _ { h _ { a } } ^ { 2 } - m _ { V } ^ { 2 } } | ^ { 2 } } R _ { 2 i } ^ { 2 } , } } \\ { { < \sigma v > _ { A A  h _ { a } h _ { a } } ^ { t + u } = \displaystyle \frac { 1 } { 4 \pi } \displaystyle \frac { 1 } { m _ { A } ^ { 2 } } [ \sqrt { 1 - \frac { m _ { h _ { a } } ^ { 2 } } { m _ { A } ^ { 2 } } } | \frac { ( \delta _ { 2 } v / 2 ) ^ { 2 } R _ { 1 i } } { m _ { h _ { 1 } } ^ { 2 } - m _ { A } ^ { 2 } } | ^ { 2 } + \sqrt { 1 - \frac { m _ { h _ { 2 } } ^ { 2 } } { m _ { A } ^ { 2 } } } | \frac { ( \delta _ { 1 } v _ { \phi } / 2 ) ^ { 2 } R _ { 2 i } } { m _ { h _ { 2 } } ^ { 2 } - m _ { A } ^ { 2 } } | ^ { 2 }  } } \\ { { \displaystyle  + \sqrt { 1 - \frac { m _ { h _ { 3 } } ^ { 2 } } { m _ { A } ^ { 2 } } } | \frac { ( d _ { 2 } v _ { s } / 2 ) ^ { 2 } R _ { 3 i } } { m _ { h _ { 3 } } ^ { 2 } - m _ { A } ^ { 2 } } | ^ { 2 } ] . } } \end{array}
$$
...
[3]L. Bian, R. Ding and B. Zhu,Phys. Lett.B 728,105 (2014) [arXiv:1308.3851 [hep-phl]l.   
...
[6] C. N. Karahan and B. Korutlu, Phys. Lett. B 732, 320 (2014) [arXiv:1404.0175 [hep-phll.   
...
[10] C. Englert and M. McCullough, JHEP 1307, 168 (2013) [arXiv:1303.1526 [hep-ph]].   
[11] M. Farina, M. Perelstein and N.R.L. Lorier, Phys. Rev. D 90, O15014 (2014) [arXiv:1305.6068 [hep-ph].   
[12] A. Noble and M. Perelstein, Phys. Rev. D 78, 063518 (2008) [arXiv:0711.3018 [hep-ph]].   
[13] P. H. Damgaard, D. O'Connell T. C. Petersen and A. Tranberg, Phys. Rev. Lett. 111, no. 22,221804 （2013) [arXiv:1305.4362 [hep-phl].   
...
