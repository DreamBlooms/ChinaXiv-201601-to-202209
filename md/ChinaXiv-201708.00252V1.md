...
where M is the nucleon mass,and mo, go,mw, gw,mp, 9p masses and coupling constants of the respective mesons. The nonlinear self-coupling for the scalar meson is given by [73]
...
![](images/c416adfd49bb966a3af55067bdaa9f698dd1495d45a2fb4ea057b7586f0b018f.jpg)  
...
Figure 7 shows neutron density profiles of even-even magnesium isotopes with $A \geq 2 8$ calculated with the parameter set PK1. $\rho _ { \mathrm { n , \lambda = 0 } } ( r )$ represents the spherical component of the neutron density distribution (cf. Eq.14). $\rho _ { \mathrm { n } } ( z , r _ { \perp } = 0 )$ with $r _ { \perp } = \sqrt { x ^ { 2 } + y ^ { 2 } }$ refers to the density distribution along the symmetry axis $z$ ( $\theta = 0 ^ { \circ }$ )and $\rho _ { \mathrm { n } } ( z = 0 , r _ { \perp } )$ refers to that perpendicular to the symmetry axis $z$ ( $\theta = 9 0 ^ { \circ }$ ).With increasing $A$ ，the spherical
...
[19]W.Schwab，H. Geissel，H.Lenske，K.H.Behr, A．Brünle,K.Burkard，H.Irnich，T．Kobayashi, G.Kraus,A. Magel, G. Münzenberg,F.Nickel,K.Riisager, C. Scheidenberger,B.M. Sherrill, T. Suzuki，and B. Voss, Z. Phys. A 350, 283 (1995).   
...
where $\hat { \jmath } = \sqrt { 2 j + 1 }$ .For odd values of $l + \lambda + l ^ { \prime }$ these matrix elements vanish.
...
Theintegralinthepairingmatrixelement $\langle n \kappa m | \Delta | n ^ { \prime } \kappa ^ { \prime } m \rangle$ contains the time reversal basis function. Since the pairing interaction Eq.(11） projects onto the $S = 0$ we have to couple the product $\phi _ { n \kappa m } ( \pmb { r } s ) \phi _ { n ^ { \prime } \kappa ^ { \prime } m } ( \pmb { r } s )$ to spin $S = 0$ and find
...
$$
\langle n \kappa | \Delta ^ { -- } | n ^ { \prime } \kappa ^ { \prime } \rangle = \sum _ { \lambda } \langle \kappa m | P _ { \lambda } | \kappa ^ { \prime } m \rangle \int d r F _ { n \kappa } \Delta _ { \lambda } ( r ) F _ { n ^ { \prime } \kappa ^ { \prime } }
$$

(B8) where the potentials $\Delta _ { \lambda } ( r )$ will be given in Appendix $\mathrm { E }$

# Appendix C:Calculation of the densities

In order to determine the self-consistent fields in the next step of the iteration we first have to determine the densities. Starting from the expansion coefficients $u _ { k , ( n \kappa ) } ^ { ( m ) }$ and $v _ { k , ( n \kappa ) } ^ { ( m ) }$ obtained through the diagonalization of the RHB matrix(19) we find the density matrix in the Woods-Saxon basis

$$
\rho _ { ( n \kappa ) ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } = \sum _ { k > 0 } v _ { k , ( n \kappa ) } ^ { ( m ) * } v _ { k , ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } .
$$

Next we transform these densities to coordinate space and find for the local part

$$
\begin{array} { r } { \rho ( \pmb { r } p ) = 2 \displaystyle \sum _ { m > 0 } \displaystyle \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } \sum _ { s } \phi _ { n \kappa m } ( \pmb { r } s p ) \rho _ { ( n \kappa ) , ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } \phi _ { n ^ { \prime } \kappa ^ { \prime } m } ^ { * } ( \pmb { r } s p ) } \\ { = \displaystyle \sum _ { \lambda } \rho _ { \lambda } ( \pmb { r } , p ) P _ { \lambda } ( \Omega ) . \qquad ( \mathbb { C } 2 } \end{array}
$$

Using Eq. (A7) we finally obtain the various local densities

$$
\begin{array} { l } { { \displaystyle \rho _ { \lambda } ^ { s } ( \boldsymbol { r } ) = 2 \frac { 2 \lambda + 1 } { 4 \pi r ^ { 2 } } \sum _ { m > 0 } \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } \rho _ { ( n \kappa ) ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } \left[ G _ { n \kappa } ( r ) G _ { n ^ { \prime } \kappa ^ { \prime } } ( r ) - F _ { n \kappa } ( r ) F _ { n ^ { \prime } \kappa ^ { \prime } } ( r ) \right] \langle \kappa m | P _ { \lambda } | \kappa ^ { \prime } m \rangle , } } \\ { { \displaystyle \rho _ { \lambda } ^ { v } ( \boldsymbol { r } ) = 2 \frac { 2 \lambda + 1 } { 4 \pi r ^ { 2 } } \sum _ { m > 0 } \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } \rho _ { ( n \kappa ) ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } \left[ G _ { n \kappa } ( r ) G _ { n ^ { \prime } \kappa ^ { \prime } } ( r ) + F _ { n \kappa } ( r ) F _ { n ^ { \prime } \kappa ^ { \prime } } ( r ) \right] \langle \kappa m | P _ { \lambda } | \kappa ^ { \prime } m \rangle , } } \end{array}
$$

and similar equations for the isovector density $\rho _ { \lambda } ^ { 3 } ( r )$ and for the charge density $\rho _ { \lambda } ^ { c } ( r )$

Appendix D:Solution of the Klein-Gordon equation

The various densities are the sources of the meson fields in the Klein Gordon equations (8). These equations are

solved by integrating the densities over the static Green functions in spherical coordinates. For simplicity we give here the details only for the $\sigma$ meson

$$
\begin{array} { r } { D ( r , \theta , r ^ { \prime } , \theta ^ { \prime } , m _ { \sigma } ) = - m _ { \sigma } \displaystyle \sum _ { \lambda } j _ { \lambda } ( i m _ { \sigma } r _ { < } ) h _ { \lambda } ^ { ( 1 ) } ( i m _ { \sigma } r _ { > } ) } \\ { \times ( 2 \lambda + 1 ) P _ { \lambda } ( \cos \theta ) P _ { \lambda } ( \cos \theta ^ { \prime } ) , ( \mathrm { D } } \end{array}
$$

and the photon

$$
D ( r , \theta , r ^ { \prime } , \theta ^ { \prime } ) = \sum _ { \lambda } \frac { r _ { < } ^ { \lambda } } { r _ { > } ^ { \lambda + 1 } } P _ { \lambda } ( \cos \theta ) P _ { \lambda } ( \cos \theta ^ { \prime } ) .
$$

Here $r _ { > } = \operatorname* { m a x } ( r , r ^ { \prime } )$ and $r _ { < } = \mathrm { m i n } ( r , r ^ { \prime } )$ . The solution for the $\sigma$ field is

$$
\sigma ( { \pmb r } ) = \sum _ { \lambda } \sigma _ { \lambda } ( r ) P _ { \lambda } ( \cos \theta ) ,
$$

with

$$
\begin{array} { c } { { \displaystyle \sigma _ { \lambda } ( \boldsymbol { r } ) = - 4 \pi g _ { \sigma } m _ { \sigma } \left( h _ { \lambda } ( i m _ { \sigma } r ) \int _ { 0 } ^ { r } d r ^ { \prime } j _ { \lambda } ( i m _ { \sigma } r ^ { \prime } ) \rho _ { \lambda } ^ { s } ( r ^ { \prime } ) \right. } } \\ { { \displaystyle \left. + j _ { \lambda } ( i m _ { \sigma } r ) \int _ { r } ^ { \infty } d r ^ { \prime } h _ { \lambda } ( i m _ { \sigma } r ^ { \prime } ) \rho _ { \lambda } ^ { s } ( r ^ { \prime } ) \right) , \quad \mathrm { ( D ~ } } } \end{array}
$$

where $j _ { \lambda }$ and $h _ { \lambda }$ are the sphericalBessel and Hankel functions.Similarly we find for the Coulomb field

$$
A _ { \lambda } ^ { 0 } ( r ) = \frac { 1 } { r ^ { \lambda + 1 } } \int _ { 0 } ^ { r } d r ^ { \prime } r ^ { \prime \lambda } \rho _ { \lambda } ^ { c } ( r ^ { \prime } ) + r ^ { \lambda } \int _ { r } ^ { \infty } d r ^ { \prime } \frac { 1 } { r ^ { \prime \lambda + 1 } } \rho _ { \lambda } ^ { c } ( r ^ { \prime } ) .
$$

From the $\lambda$ components of the meson fields $\sigma _ { \lambda } ( \boldsymbol { r } )$ ， $\omega _ { \lambda } ^ { 0 } ( \boldsymbol { r } )$ $\rho _ { \lambda } ^ { 0 } ( r )$ and $A _ { \lambda } ^ { 0 } ( \boldsymbol { r } )$ we find immediately the corresponding components of the scalar and the vector potential given in Eqs. (6) and (7).

# Appendix E:Pairing fields and tensors

As in the case of the normal density we first calculate the pairing tensor $\kappa$ in the Woods Saxon basis

$$
\kappa _ { ( n \kappa ) ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } = \sum _ { k > 0 } v _ { k , ( n \kappa ) } ^ { ( m ) * } u _ { k , ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } .
$$

Next we transform it to coordinate space and obtain $\kappa ( r s p , r ^ { \prime } s ^ { \prime } p ^ { \prime } )$ .This isa 2 $? \times$ 2 matrix in spin space and therefore it can be expressed in terms of the unity and the Pauli matrices

$$
\kappa ( \boldsymbol { r } s p , \boldsymbol { r } ^ { \prime } s ^ { \prime } p ^ { \prime } ) = \kappa ( \boldsymbol { r } p , \boldsymbol { r } ^ { \prime } p ^ { \prime } ) + \kappa ( \boldsymbol { r } p , \boldsymbol { r } ^ { \prime } p ^ { \prime } ) \cdot \boldsymbol { \sigma } ,
$$

where $\kappa ( r p , r ^ { \prime } p ^ { \prime } )$ is the $S = 0$ part and $\kappa ( r p , r ^ { \prime } p ^ { \prime } )$ isa vector，the $S ~ = ~ 1$ part of the pairing tensor. We realize that the special form of the pairing interaction in Eq.(11） guarantees that we do not need the full matrix $\kappa ( r s p , r ^ { \prime } s ^ { \prime } p ^ { \prime } )$ ．As a consequence of the zero range we need only the local part of this matrix,and since the force acts in the $S = 0$ channel,only the spin scalar part of $\kappa$ contributes.It is obtained by coupling to $S = 0$

$$
\kappa ( r , p , p ^ { \prime } ) = { \sum _ { s } } ( - ) ^ { s + \frac { 1 } { 2 } } \kappa ( r s p , r \mathrm { - } s p ^ { \prime } ) .
$$

As mentioned above,in this work we take into account only pairing fields which are diagonal in the quantum number $p$ ：

Because of the symplectic structure of the RHB equations the pairing tensor $\kappa$ connects basis states $| n \kappa m \rangle$ with the time reversal states $| \overline { { n ^ { \prime } \kappa ^ { \prime } m } } \rangle$ .Using the same arguments as in Eq.(B6)we obtain for the local and scalar part of the pairing density

$$
\begin{array} { c } { { \kappa ( { \pmb r } p ) = 2 \displaystyle \sum _ { m > 0 } \displaystyle \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } \sum _ { s } \phi _ { k } ( { \pmb r } s p ) \kappa _ { ( n \kappa ) , ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } \phi _ { k ^ { \prime } } ^ { * } ( { \pmb r } s p ) } } \\ { { = \displaystyle \sum _ { \lambda } \kappa _ { \lambda } ( { \pmb r } , p ) P _ { \lambda } ( \Omega ) . } } \end{array}
$$

Finally with the help of Eq. (A7) we obtain the pairing densities in various $\lambda$ -channels

$$
\begin{array} { l } { { \kappa _ { \lambda } ^ { + + } ( r ) = 2 { \frac { 2 \lambda + 1 } { 4 \pi r ^ { 2 } } } \displaystyle \sum _ { m > 0 } \displaystyle \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } G _ { n \kappa } \kappa _ { ( n \kappa ) , ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } G _ { n ^ { \prime } \kappa ^ { \prime } } } } \\ { { \times \langle \kappa m | P _ { \lambda } | \kappa ^ { \prime } m \rangle , } } \\ { { \kappa _ { \lambda } ^ { -- } ( r ) = 2 { \frac { 2 \lambda + 1 } { 4 \pi r ^ { 2 } } } \displaystyle \sum _ { m > 0 } \displaystyle \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } F _ { n \kappa } \kappa _ { ( n \kappa ) , ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } F _ { n ^ { \prime } \kappa ^ { \prime } } } } \\ { { \times \langle \kappa m | P _ { \lambda } | \kappa ^ { \prime } m \rangle . } } \end{array}
$$

Asa consequence of these simplifications the gap equation(1O)has the local form

$$
\Delta ( r , p ) = V _ { 0 } f ( r ) \kappa ( r , p )
$$

with $f ( \boldsymbol { r } ) = ( 1 - \rho ( \boldsymbol { r } ) / \rho _ { \mathrm { s a t } } )$ . The decomposition of this equation into spherical harmonics yields

$$
\Delta _ { \lambda } ( r ) = ( 2 \lambda + 1 ) V _ { 0 } \sum _ { \lambda ^ { \prime } , \lambda ^ { \prime \prime } } f _ { \lambda ^ { \prime } } ( r ) \kappa _ { \lambda ^ { \prime \prime } } ( r ) \left( { \lambda \lambda ^ { \prime } \lambda ^ { \prime \prime } } \right) ^ { 2 } ,
$$

$$
\mathrm { a n d } f _ { \lambda } ( r ) = ( \delta _ { \lambda 0 } - \rho ( r ) _ { \lambda } / \rho _ { \mathrm { s a t } } ) ,
$$

# Appendix F:Relativistic structure of the pairing field

So far we have neglected parts of the pairing field which connect large and small components,i.e.，we have assumed that

$$
\Delta ^ { + - } ( r ) = \kappa ^ { + - } ( r ) = 0 .
$$

Since the density $\rho ( \pmb { r } )$ and the density-dependent function $f ( \rho ( \pmb { r } ) )$ of the pairing interaction does not mix these components, the structure of Eq.( $1 3 8$ ）shows also very clearly that the pairing tensor $\kappa ( \pmb { r } )$ and the pairing field $\Delta ( r )$ are in this respect completely connected.If $\kappa ( \pmb { r } )$ mixes these components,so does $\Delta$ ：

Considering the structure of Eqs.(E5）and(E6） we find that a non-vanishing term $\kappa ^ { + - } ( r )$ would have the form

$$
\begin{array} { r } { \kappa _ { \lambda } ^ { + - } ( r ) = 2 \frac { 2 \lambda + 1 } { 4 \pi r ^ { 2 } } \displaystyle \sum _ { m > 0 } \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } G _ { n \kappa } \kappa _ { ( n \kappa ) , ( n ^ { \prime } \kappa ^ { \prime } ) } ^ { ( m ) } F _ { n ^ { \prime } \kappa ^ { \prime } } } \\ { \times \langle \kappa m | P _ { \lambda } | \kappa ^ { \prime } m \rangle . } \end{array}
$$

Since large and small components have different parity, non-vanishing values of this function would require odd values of ${ \mathit { l } } + { \mathit { l } } ^ { \prime }$ and because of the parity selection rule in $\langle \kappa m | P _ { \lambda } | \kappa ^ { \prime } m \rangle$ also odd values of $\lambda$ . This means the parts of $\kappa ^ { + - } ( r )$ and $\Delta ^ { + - } ( r )$ can only be expanded in components with odd $\lambda$ values.Of course,this fact is rather trivial. It does not violate parity, because even the simple Dirac equation with parity conserving fields have large and small components with different parity: $h _ { D } ^ { + - } = \sigma \cdot p$ has also a negative parity.

We can conclude that in the spherical case，where $\lambda ~ = ~ 0$ and even,the field $\Delta ^ { + - } ( r )$ has to vanish.In the deformed case this is not necessarily true.On the other side,these considerations depend on the interaction,as for instance on the fact that the pairing force we have used here excludes $S = 1$ . In particular we did not take into account odd $\lambda$ -values in the pairing field and therefore $\Delta ^ { + - }$ fields are excluded from the beginning. If we would allow for $S = 1$ pairs,spin-vector components of the form $\Delta \cdot \alpha$ mixing large and small components are not excluded,even in the spherical case,because in this case $L = 1$ and $S = 1$ can couple to $J ~ = ~ 0$ .Of course this depends on the interaction. In Ref.[82] the $S = 1$ part of the zero range pairing force was not excluded and non-vanishing pairing fields $\Delta ^ { + - }$ were taken into account.However, they turned out to be an order of magnitude smaller than the diagonal matrix elements $\Delta ^ { + + }$ . In particular they are very small as compared to the term $\sigma \cdot p$ which mixes large and small components in the Dirac Hamiltonian.Therefore they can be neglected asa very good approximation.

# Appendix G:Microscopic center of mass correctior

The center of mass correction in Eq. (27） which is widely used in the literature [75] can be derived as a first

order correction to a projection after variation [1O8] onto good linear momentum.In Ref.[1o9] this term has been derived in the framework of the BCS approximation as

$$
\begin{array} { r l r } {  { \frac { \langle \hat { \bf P } ^ { 2 } \rangle } { 2 A m } = - \frac { \hbar ^ { 2 } } { A m } [ \sum _ { i > 0 } v _ { i } ^ { 2 } \Delta _ { i i } +  } } & { { \mathrm { ( G 1 } } } \\ & { } & { +  \sum _ { i , i ^ { \prime } > 0 } [ v _ { i } v _ { i ^ { \prime } } ( v _ { i } v _ { i ^ { \prime } } + u _ { i } u _ { i ^ { \prime } } ) ( | \nabla _ { i i ^ { \prime } } | ^ { 2 } + | \nabla _ { i \bar { i ^ { \prime } } } | ^ { 2 } ) ] ] . } \end{array}
$$

In the following we show, how this formula can be applied in the framework of relativistic Hartree-Bogoliubov theory. In a first step we use the fact that any HartreeBogoliubov wavefunction can be expressed in the form ofa BCS-state in the canonical basis [75]. This basis is obtained by the diagonalization of the density matrix in $\rho = V ^ { * } V ^ { \tau }$ in the Woods-Saxon basis (18)

$$
\sum _ { n ^ { \prime } \kappa ^ { \prime } } \rho _ { n \kappa , n ^ { \prime } \kappa ^ { \prime } } ^ { m } c _ { n ^ { \prime } \kappa ^ { \prime } } ^ { i } = v _ { i } ^ { 2 } c _ { n \kappa } ^ { i } .
$$

The eigenvalues $v _ { i } ^ { 2 }$ are the BCS-occupation probabilities and the eigenvectors are the expansion coefficients of the canonical wave functions in the spherical spinors of the Woods-Saxon basis

$$
\Phi _ { i } ( \pmb { r s } ) = \sum _ { n \kappa } c _ { n \kappa } ^ { i } \varphi _ { n \kappa m } ( \pmb { r s } ) .
$$

Here, $i = ( n m \pi )$ where $m$ is the third component of the angular momentum $j$ and $\pi = \pm$ is the parity.

Of course the eigenvalues of Eq. (G2） provide us only the absolute values of the occupation amplitudes $v _ { i }$ and $u _ { i } = \sqrt { 1 - v _ { i } ^ { 2 } }$ . In Eq. (G2) we also need the sign of $u _ { i } v _ { i }$ It is determined by the diagonal elements of the pairing tensor in the canonical basis,

$$
u _ { i } v _ { i } \ = \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } c _ { n \kappa } ^ { i } c _ { n ^ { \prime } \kappa ^ { \prime } } ^ { i } \kappa _ { ( n \kappa ) ( n ^ { \prime } \kappa ^ { \prime } ) } \ .
$$

For the direct term we need the diagonal matrix ele ments of the Laplacian

$$
\begin{array} { l } { \displaystyle \Delta _ { i i } = - \sum _ { n n ^ { \prime } \kappa } c _ { n \kappa } ^ { i } c _ { n ^ { \prime } \kappa } ^ { i } \int d \boldsymbol { r } \left\{ \frac { \partial G _ { n \kappa } ( \boldsymbol { r } ) } { d \boldsymbol { r } } \frac { \partial G _ { n ^ { \prime } \kappa } ( \boldsymbol { r } ) } { \partial \boldsymbol { r } } + l ( l + 1 ) \frac { G _ { n \kappa } ( \boldsymbol { r } ) G _ { n ^ { \prime } \kappa } ( \boldsymbol { r } ) } { r ^ { 2 } } \right. } \\ { \displaystyle \left. + \frac { \partial F _ { n \kappa } ( \boldsymbol { r } ) } { d \boldsymbol { r } } \frac { \partial F _ { n ^ { \prime } \kappa } ( \boldsymbol { r } ) } { \partial \boldsymbol { r } } + \tilde { l } ( \boldsymbol { l } + 1 ) \frac { F _ { n \kappa } ( r ) F _ { n ^ { \prime } \kappa } ( \boldsymbol { r } ) } { r ^ { 2 } } \right\} . } \end{array}
$$

For the exchange term, we have $\begin{array} { r } { | \nabla _ { i i ^ { \prime } } | ^ { 2 } = \sum _ { \mu } ( - ) ^ { \mu } ( \nabla _ { \mu } ) _ { i i ^ { \prime } } ( \nabla _ { - \mu } ) _ { i i ^ { \prime } } } \end{array}$ and according to the Wigner-Eckart theorem [107]

we find for the spherical coordinate $\mu$ of the gradient operator

$$
( \nabla _ { \mu } ) _ { i i ^ { \prime } } = \sum _ { n \kappa } ^ { n ^ { \prime } \kappa ^ { \prime } } c _ { n \kappa } ^ { i } c _ { n ^ { \prime } \kappa ^ { \prime } } ^ { i ^ { \prime } } ( - ) ^ { j - m } \left( \begin{array} { l l l } { j } & { 1 } & { j ^ { \prime } } \\ { - m } & { \mu } & { m ^ { \prime } } \end{array} \right) \langle \phi _ { n \kappa } | | \nabla | | \phi _ { n ^ { \prime } \kappa ^ { \prime } } \rangle ,
$$

with the reduced matrix element

$$
\begin{array} { l } { { \langle \phi _ { n \kappa } | | \nabla | | \phi _ { n ^ { \prime } \kappa ^ { \prime } } \rangle = ( - ) ^ { j - 1 / 2 } \hat { \jmath } \jmath ^ { \prime } \left[ ( - ) ^ { l ^ { \prime } } \left\{ \begin{array} { l l } { { \jmath ^ { \prime } j \uparrow 1 } } \\ { { l \ l ^ { \prime } \frac { 1 } { 2 } } } \end{array} \right\} \int d r G _ { n \kappa } ( r ) \langle l | | \nabla | | l ^ { \prime } \rangle G _ { n ^ { \prime } \kappa ^ { \prime } } ( r ) \right. } } \\ { { \left. + ( - ) ^ { \tilde { l } ^ { \prime } } \left\{ \begin{array} { l l } { { \jmath ^ { \prime } j \uparrow 1 } } \\ { { \tilde { l } \tilde { l } ^ { \prime } \frac { 1 } { 2 } } } \end{array} \right\} \int d r F _ { n \kappa } ( r ) \langle \tilde { l } | | \nabla | | \tilde { l } ^ { \prime } \rangle F _ { n ^ { \prime } \kappa ^ { \prime } } ( r ) \right] , } } \end{array}
$$

where $\hat { \jmath } = \sqrt { 2 j + 1 }$ and the expression $\langle l | | \nabla | | l ^ { \prime } \rangle$ is the reduced matrix element of $\nabla$ with respect to the integration overthe angles.Ofcourse,it stillcontains derivatives with respect to theradialcoordinate.Following Sect.5.7of Ref. [107],we obtain

$$
\langle l | | \nabla | | l ^ { \prime } \rangle = \delta _ { l , l ^ { \prime } + 1 } \sqrt { l } \left[ \frac { d } { d r } - \frac { l } { r } \right] - \delta _ { l , l ^ { \prime } - 1 } \sqrt { l ^ { \prime } } \left[ \frac { d } { d r } + \frac { l ^ { \prime } } { r } \right] .
$$