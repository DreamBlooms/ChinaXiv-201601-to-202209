...
（1）工程区森林覆盖率略有提高。西藏天然林保护一期工程（2000一2014年）累计完成生态公益林建设8.25万 $\mathrm { { h m } } ^ { 2 }$ ，工程区森林覆盖率由原来的 $3 8 . 6 \%$ 提至 $3 9 . 5 \%$ ，增加率为 $0 . 9 \%$ 。禁止砍伐森林后，森林资源总消耗量由过去的150.5万 $\mathrm { ~ m ~ } ^ { 3 }$ ，降低到目前的69.4万 $\mathfrak { m } ^ { 3 }$ ，减少 $5 3 . 9 \%$
