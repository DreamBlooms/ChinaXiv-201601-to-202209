...
其中， $\mathbf { A } _ { \mathrm { i } \times l }$ 为网络的链接矩阵。
...
(3）根据相似性指标计算方法，遍历所有节点对$< \mathbf { x } , \mathbf { y } >$ ，计算节点对的相似性指标分数 score $( \mathbf { x } , \mathbf { y } )$ ，并依据指标数值大小排序。
...
(1）5、28、18、22、25、29等节点在 $100 \%$ 的相似水平上具有规则对等性;
