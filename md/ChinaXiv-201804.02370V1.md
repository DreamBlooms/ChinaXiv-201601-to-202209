...
其中： $C _ { i }$ 是Voronoi区域， ${ \bf d } ( { \bf x } , y _ { i } )$ 表示输入向量和代表矢量的欧氏距离。
...
![](images/97be7ddc84f37fa7dce884ced7732d42074ee101731c46456a8db32bd6931f66.jpg)  
图6层级集合对应于包围盒
