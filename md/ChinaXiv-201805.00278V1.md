...
${ < } \mathrm { B } _ { \mathrm { c } }$ .start-build $( 4 < 7 )$ ， $\mathrm { B } _ { \mathrm { b } }$ .finish-build> ${ \bf \cdot B } _ { \mathrm { c } }$ .finish-build( $1 1 { > } 1 0 _ { , }$ L所以b是a的祖先节点。任意两节点都能根据该性质通过start-build与finish-build信息来判定是否存在祖先-子孙关系。
