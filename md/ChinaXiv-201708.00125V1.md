...
4 The $b _ { i L , R }$ for different initial electron helicities $e _ { L , R } ^ { - }$ are
...
It is expected that as a whole the polar angle distributions contribute least to the sensitivities,as the magnitudes of the three curves in the middle panel of Fig.1 are the smallest. Among these three curves, the magnitudes of $\omega ( \cos \theta _ { 1 2 } ^ { * } )$ for $\Delta \kappa _ { \gamma }$ is significantly larger than other couplings,implying that the polar angles are most sensitive to the couplings $\Delta \kappa _ { \gamma }$ （20 and contribute significantly in constraining it. Taking into account the SM distributions （20 $\mathrm { d } \sigma _ { 0 } / \mathrm { d } \cos \theta _ { 1 , 2 } ^ { * }$ , the plot implies further that $\cos \theta _ { 1 , 2 } ^ { * } \sim 0$ is the most sensitive region in the $W$ （20 rest frame. For the azimuthal angles $\phi _ { 1 , 2 } ^ { * }$ , we can easily see in the right panels that for $\Delta g _ { 1 , Z }$ （20 and $\lambda _ { \gamma }$ the significant deviations occurs at $\phi _ { 1 , 2 } ^ { * } \sim 0$ ， $\pm \pi$ in the rest frame of $W$ bosons. Thus it is expected that distributions of the azimuthal angles suffer significant distortions due to these non-vanishing aTGCs,which in turn severely constrains the couplings and improves largely the sensitivities. For $\Delta \kappa _ { \gamma }$ the function $\omega ( \phi _ { 1 , 2 } ^ { * } )$ is almost a constant $\sim - 0 . 1 7$ ，which means that given a non-vanishing $\Delta \kappa _ { \gamma }$ the distributions $\mathrm { d } \sigma / \mathrm { d } \phi _ { 1 , 2 } ^ { * }$ are rescaled by a factor of $( 1 - 0 . 1 7 \Delta \kappa _ { \gamma , }$ ）
...
To examine the contributions to the sensitivities from the distributions with respect to the five kinematic angles $\cos \theta$ ， $\cos \theta _ { \ell } ^ { * }$ ， $\phi _ { \ell } ^ { * }$ ， $\cos \theta _ { \jmath } ^ { * }$ ， $\phi _ { \jmath } ^ { * }$ ， we calculate
...
where $\mathcal { O } _ { H W }$ ， $\mathcal { O } _ { H B }$ are defined in Eq. (3) and
...
# Appendix B: Analytical expressions for the coefficients $\omega _ { i }$ （204号
...
TABLE VIII: The same as Table III, but for the five most general $C$ and $P$ conserving aTGCs $( 1 0 ^ { - 4 } \$ ）in Eq.(2) from $p p  W ^ { + } W ^ { - }$ at 14 TeV LHC.
...
When the anomalous couplings are correlated by the EW gauge symmetry,
...
$$
\begin{array} { r l } { \omega _ { i } ( \mathrm { c s c s s } \theta ) \frac { \mathrm { d } \omega _ { 0 } } { \mathrm { c c o s s } \theta } = } & { \frac { 1 } { ( 1 - \Theta ) 9 5 \mathrm { i } 1 \mathrm { c o s s } \theta ^ { 3 / 2 } } \left[ \left( \frac { - 2 . 7 3 9 5 } { - 1 . 9 7 7 \mathrm { s } } \right) ^ { \epsilon } - \left( \frac { 5 . 5 6 8 \mathrm { s } } { 4 . 1 1 } \right) \mathrm { c o s s } \theta \right. } \\ & { \left. - \left( \frac { - 2 . 3 4 2 2 } { - 1 . 2 0 \mathrm { b } } \right) \mathrm { c o s s } ^ { 2 } \theta + \left( - 1 . 4 8 6 8 \mathrm { s } ^ { 3 } \right) \mathrm { c o s s } ^ { 3 } \theta + \left( \begin{array} { c } { - 0 . 2 5 5 9 \mathrm { s } } \\ { 0 . 8 5 9 3 } \\ { 0 . 8 5 9 3 } \end{array} \right) \mathrm { c o s s } \right] } \\ { \omega \mathrm { d } \omega _ { \mathrm { L } , 2 } \frac { \mathrm { d } \omega _ { 0 } } { \mathrm { d } \omega _ { 0 } \mathrm { c o s s } \theta } = } & { \left( \begin{array} { c } { - 1 . 3 6 9 9 \mathrm { s } } \\ { - 0 . 1 9 9 9 } \\ { - 1 . 0 0 0 3 } \end{array} \right) - \left( \frac { - 0 . 5 9 1 7 \mathrm { s } } { - 0 . 1 1 7 \mathrm { b } } \right) \mathrm { c o s s } \theta \frac { \mathrm { d } \omega _ { \mathrm { L } , 2 } } { \mathrm { c o s s } ^ { 3 } \theta } + \left( \begin{array} { c } { 1 . 0 1 6 } \\ { 1 . 3 7 \mathrm { b } } \\ { - 0 . 5 9 5 6 } \end{array} \right) \mathrm { c o s s } ^ { 2 } \theta _ { 1 , 2 } , } \end{array}
$$

$$
\omega _ { i } ( \phi _ { 1 , 2 } ^ { * } ) { \frac { \mathrm { d } \sigma _ { 0 } } { \mathrm { d } \phi _ { 1 , 2 } ^ { * } } } = { \begin{array} { l } { \left( - 0 . 3 2 7 9 \right) } \\ { - 0 . 4 2 4 1 } \\ { - 0 . 2 8 3 7 } \end{array} } \pm { \left( \begin{array} { l } { 1 . 4 3 3 } \\ { 0 . 0 6 5 7 5 } \\ { 1 . 0 9 5 } \end{array} \right) } \cos \phi _ { 1 , 2 } ^ { * } + { \left( \begin{array} { l } { - 0 . 0 3 5 7 0 } \\ { - 0 . 0 1 3 5 3 } \\ { - 0 . 4 2 6 4 } \end{array} \right) } \cos ^ { 2 } \phi _ { 1 , 2 } ^ { * } .
$$

Analogue to Eq. (C3)， integrations of the $\omega$ distributions lead us to the $b _ { i }$ coefficients in Eq. (A1) for the total cross sections.

[1] D.Marzocca,M. Serone and J. Shu, JHEP 1208,013 (2012) [arXiv:1205.0770 [hep-ph].   
[2] K. Hagiwara, R. D. Peccei, D. Zeppenfeld and K. Hikasa, Nucl. Phys. B 282, 253 (1987).   
[3] S.Weinberg, Physica A 96,327 (1979).   
[4] S. Weinberg, Rev.Mod. Phys. 52, 515 (1980) [Science 210,1212 (1980)].   
[5] A. De Rujula, M. B. Gavela, P. Hernandez and E. Masso, Nucl. Phys. B 384,3 (1992).   
[6] K.Hagiwara, S. Ishihara, R. Szalapski and D. Zeppenfeld, Phys. Lett. B 283,353 (1992).   
[7] K. Hagiwara, S. Ishihara, R. Szalapski and D. Zeppenfeld, Phys. Rev. D 48, 2182 (1993).   
[8] U. Baur and D. Zeppenfeld, Phys. Lett. B 201, 383 (1988).   
[9] D. Zeppenfeld and S. Willenbrock, Phys.Rev. D 37,1775 (1988).   
[10] K. Hagiwara, J. Woodside and D. Zeppenfeld, Phys. Rev. D 41, 2113 (1990).   
[11] C. Grojean,W. Skiba and J. Terning, Phys. Rev. D 73, 075008 (2006) [hep-ph/0602154].   
[12] T. Corbett, O. J. P. Eboli, J. Gonzalez-Fraile and M. C. Gonzalez-Garcia, Phys. Rev. Lett. 111,011801 (2013)[arXiv:1304.1151 [hep-ph].   
[13] C. Bobeth and U. Haisch,arXiv:1503.04829 [hep-ph].   
[14] S. Schael et al. [ALEPH and DELPHI and L3 and OPAL and LEP Electroweak Collaborations],Phys. Rept. 532,119 (2013) [arXiv:1302.3415 [hep-ex].   
