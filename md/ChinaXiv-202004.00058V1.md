...
2.3.3农作物知识规则的建立小麦、香梨和芦苇3 种作物的生长期早于辣椒、棉花和玉米,5月中旬，小麦处于孕穗期，香梨处于叶子生长期，植被覆盖度很高;而玉米、棉花和辣椒处于出苗期，植被覆盖度很低，NDVI值远低于0.4。选择5月16日（第137d)的关键期影像将其分为两大类，分类规则为：$\mathrm { ( N D V I } _ { 5 / 1 6 } > 0 . 4 \mathrm { ) }$ 。接下来在每一类中进行细分。
