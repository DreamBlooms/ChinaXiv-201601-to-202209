...
（1）星点可视化。利用Excel将恒星的星等、光谱型与恒星在天球的坐标一一对应，通过Excel插件导入WWT中，用不同大小和颜色的光点表示各个恒星的星等和光谱型。部分数据如图1。
...
（3）促进中国传统星空文化的大众性。通过WWT集成的数字化教育资源，所有公众均可以网络获取并使用，让以往只有天文学家才能问津的顶级专业天文资源走近了每一个普通公众。
