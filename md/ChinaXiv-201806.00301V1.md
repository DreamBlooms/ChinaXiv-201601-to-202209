...
Keywords: Bauhinia championii Benth,Biological activity,Methanol extracts, Separation and purification, Monomer compounds
...
取粗提物 $5 0 . 0 0 \mathrm { g }$ ，用少量甲醇热熔后，与 $5 0 . 0 0 \ \mathrm { g }$ 硅胶(200-300 目)充分拌匀、晾干，装入硅胶层析柱 $( 6 . 0 0 \ \mathrm { c m } { \times } 8 0 . 0 0 \ \mathrm { c m }$ ，200-300目硅胶 $4 0 0 . 0 0 \ \mathrm { g } )$ ，依次用乙酸乙酯:石油醚(0:1-1:0)、 $100 \%$ 乙酸乙醋、氯仿:甲醇(0:1-1:0)和 $100 \%$ 甲醇进行梯度洗脱，各梯度溶剂为3000ml，每 $2 0 0 \mathrm { m l }$ 为1个组分收集洗脱液， $5 0 ^ { \circ } \mathrm { C }$ 减压浓缩，GF254薄层层析硅胶板展开，254$\mathrm { { n m } }$ 紫外荧光仪下检识或碘缸显色，合并Rf值相同的组分，获得9个组分。对7号和8号组分中析出的物质，少量甲醇热熔，反复重结晶，TLC 检识合和熔点测定，获取纯化合物。

# 1.2.3 药液的配置

分别称取 $0 . 5 0 ~ \mathrm { g }$ 龙须藤叶粗提物和 $0 . 2 5 \ \mathrm { g }$ 各组分于 $1 5 ~ \mathrm { m L }$ 棕色样品瓶中，用丙酮并用超声波清洗器助溶，在超净工作台中用含 $0 . 1 \%$ 吐温80的无菌去离子水定容至 $5 0 ~ \mathrm { m L }$ ，粗提物配成 $1 0 0 0 0 \mu \mathrm { g } \bullet \mathrm { m L } ^ { - 1 }$ 溶液，各组分配成 ${ 5 0 0 0 \mu \mathrm { g } } { \cdot } \mathrm { m L } ^ { - 1 }$ 溶液，用于杀菌和除草活性测定。

# 1.2.4杀菌活性试验

采用离体平皿培养法（陈小霞等，2007），用PDA培养基，以供试病原菌为对象，对所浸提的粗提物进行杀菌活性测定，培养基中供试提取物组分浓度为 $1 0 0 0 ~ \mu \mathrm { g } \bullet \mathrm { m L } ^ { - 1 }$ 。接上病原菌菌饼后于 $2 8 \mathrm { ~ \ ^ { \circ } C }$ 生化培养箱中培养，同时以等量的丙酮和含 $0 . 1 \%$ 吐温80的无菌去离子水作为对照，每处理重复3次。当对照组的菌落长至培养皿底部3/4面积后用十字交叉法（张建宁，2015）测量菌落直径，通过以下公式计算抑制率。

# 对照组菌落生长直径-处理组菌落生长直径菌落生长抑制率 $\% =$ 对照组菌落生长直径

# 1.2.5除草活性试验

用种子生物测定法（徐江艳，2013），将供试种子催芽后挑选发芽势相同的种子放于铺有中速滤纸的 $9 0 \mathrm { m m }$ 培养皿内，每皿15粒，每皿加药液 $5 \mathrm { m l }$ 。以等量的丙酮和含 $0 . 1 \%$ 吐温-80 的无菌去离子水作为对照，每处理重复3次，置于人工气候箱内培养，设置温度 $2 8 ^ { \circ } \mathrm { C }$ .

湿度 $8 0 \% \mathrm { r H }$ ，光照度 $1 1 0 0 \mathrm { l u x }$ ，光照时间为 $1 4 \mathrm { h / d }$ ，培养4-5d后测量根长和芽长，计算相对抑制率。

对照组根(茎)长度-处理组根(茎)长根(茎)生长抑制率 $\% =$ 对照组根(茎）长度

# 2．结果与分析

# 2.1粗提物的提取率与分离纯化

采用上述提取方法， $3 0 0 . 0 0 \mathrm { g }$ 龙须藤叶浸提得到 $8 5 . 7 3 \ \mathrm { g }$ 膏状物，提取率为 $2 8 . 5 8 \%$ 。根据文献报道（马力，2010），影响提取率的因素可能与溶剂浓度、提取时间、提取次数、提取温度及植物生长时期有关。 $5 0 . 0 0 \ \mathrm { g }$ 经硅胶柱层析分离后共回收样品 $3 0 . 7 1 \ \mathrm { g }$ ，回收率$6 1 . 4 2 \%$ ，结果见表1。影响回收率的因素可能跟层析柱的种类、样品的极性、过柱时间有关。

表1龙须藤各组分的质量和比例  
Table 1 Quality and proportion of each component of Bauhinia championii Benth   

<html><body><table><tr><td rowspan="2">组分编号 Component number</td><td rowspan="2">重量/g Quality / g</td><td rowspan="2">在粗提物中的比例／% The proportion in crude extract / %</td><td rowspan="2">洗脱液的种类和比例</td></tr><tr><td>The type and proportion of the eluent</td></tr><tr><td>1</td><td>8.54</td><td>27.81</td><td>乙酸乙酯：石油醚=1:10-1:8 ethyl acetate:petroleum ether=1:10-1:8</td></tr><tr><td>2</td><td>0.72</td><td>2.34</td><td>乙酸乙酯：石油醚=1:7-1:6 ethyl acetate:petroleum ether=1:7-1:6</td></tr><tr><td>3</td><td>1.08</td><td>3.52</td><td>乙酸乙酯：石油醚=1:5-1:4 ethyl acetate:petroleum ether=1:5-1:4</td></tr><tr><td>4</td><td>3.44</td><td>11.2</td><td>乙酸乙酯：石油醚=1:3-1:1 ethyl acetate:petroleum ether=1:3-1:1</td></tr><tr><td>5</td><td>2.99</td><td>9.74</td><td>乙酸乙酯：石油醚=1:0 ethyl acetate:petroleum ether=1:0</td></tr><tr><td>6</td><td>2.27</td><td>7.39</td><td>甲醇：氯仿=1:10-1:8 methanol:chloroform=1:10-1:8</td></tr><tr><td>7</td><td>3.96</td><td>12.89</td><td>甲醇：氯仿=1:7-1:4 methanol:chloroform=1:7-1:4</td></tr><tr><td>33</td><td>0.96</td><td>7.45</td><td>甲醇：氯仿=1:4-1:3 methanol:chloroform=1:4-1:3</td></tr><tr><td>8</td><td>1.42</td><td>4.62</td><td>甲醇：氯仿=1:3-1:2 methanol:chloroform=1:3-1:2</td></tr><tr><td>9</td><td>5.33</td><td>17.36</td><td>甲醇：氯仿=1:1-1:0 methanol:chloroform=1:1-1:0</td></tr></table></body></html>
...
用种子生物测定法将供试种子催芽后挑选发芽势相同的种子进行除草活性测定，测量其根、芽生长指标，计算相对抑制率，结果列于表3。结果表明，龙须藤粗提物对所有供试种子根长都有抑制效果，对稗草根的抑制率最佳，达到 $4 9 . 1 8 { \pm } 2 . 3 3 \%$ ，2号和3号组分对稗草根的抑制效果最好，分别达到 $8 8 . 9 2 { \scriptstyle \pm 1 . 3 1 \% }$ 和 $9 0 . 9 9 { \scriptstyle \pm 1 . 4 5 \% }$ ；3号和6号组分对马齿苋根抑制效果最好，分别达到 $7 2 . 0 6 { \pm } 1 . 3 1 \%$ 和 $8 9 . 9 2 { \pm } 1 . 7 3 \%$ 。可初步确定具有除草活性的成分主要集中在2号、3号和6号组分中。
...
DOU XB,LI FZ, TAN SC, et al, 2006. Zhuang integrated medical treatment of Rheumatoid arthritis 37 cases [J].Guangxi JTradit Chin Med,29 (2):45-46.[窦锡彬，李凤珍，谭树聪, 等,2006.壮医综合治疗类风湿性关节炎37例[J].广西中医药,29(2):45-46.]   
...
YE HZ, ZHENG CS,LIN W,et al, 2009. Component analysis of essential oil from Centipeda minima of Fujian province by GC-MS [J]. JFujian Coll Tradit Chin Med,19 (5) : 20-22.[叶 芝，郑春松，林薇，等,2009.气相色谱一质谱联用技术分析梅花入骨丹挥发油的化学 成分[J]．福建中医学院学报,19(5):20-22.]   
